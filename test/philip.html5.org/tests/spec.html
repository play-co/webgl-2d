<!DOCTYPE HTML>
<html lang="en-US-x-hixie" xml:lang="en-US-x-hixie"><head><meta charset="UTF-8"><title>HTML5 (including next generation additions still in development)</title><link href="http://www.whatwg.org/style/specification" rel="stylesheet"><link href="http://www.whatwg.org/images/icon" rel="icon"><style>
  ...
  </style><link href="http://www.whatwg.org/specs/web-apps/current-work/data:text/css," id="complete" rel="stylesheet" title="Complete specification"><link href="http://www.whatwg.org/specs/web-apps/current-work/data:text/css,.impl%20{%20display:%20none;%20}%0Ahtml%20{%20border:%20solid%20yellow;%20}" id="author" rel="alternate stylesheet" title="Author documentation only"><link href="http://www.whatwg.org/specs/web-apps/current-work/data:text/css,.impl%20{%20background:%20%23FFEEEE;%20}" id="highlight" rel="alternate stylesheet" title="Highlight implementation requirements"><link href="http://www.whatwg.org/specs/web-apps/current-work/status.css" rel="stylesheet"><link href="../spectest.css" type="text/css" rel="stylesheet"></head><body onload="init()" class="draft"><header class="head" id="head"><p><a href="http://www.whatwg.org/" class="logo" rel="home"><img src="http://www.whatwg.org/images/logo" alt="WHATWG"></a></p>
   <hgroup><h1>HTML5 (including next generation additions still in development)</h1>
    <h2 class="no-num no-toc">Draft Standard — 22 February 2010</h2>
   </hgroup><p class="copyright">© Copyright 2004-2009 Apple Computer, Inc.,
  ...
  </header><h4 id="the-canvas-element"><span class="secno">4.8.10 </span>The <dfn id="canvas"><code>canvas</code></dfn> element</h4>
  ...
  <dl class="element"><dt>Categories</dt>
   ...
   <dd>
    <pre class="idl">interface <dfn id="htmlcanvaselement">HTMLCanvasElement</dfn><span class="testrefs kw-none" id="testrefs.canvas.type"> <a href="#testrefs.canvas.type" title="canvas.type">#</a> <a href="type.name.html">type.name</a> <a href="type.exists.html">type.exists</a> <a href="type.delete.html">type.delete</a> <a href="type.prototype.html">type.prototype</a> <a href="type.replace.html">type.replace</a> <a href="type.extend.html">type.extend</a> </span> : <a href="#htmlelement">HTMLElement</a> {
           attribute unsigned long <a href="#dom-canvas-width" title="dom-canvas-width">width</a>;<span class="testrefs kw-none" id="testrefs.size.width"> <a href="#testrefs.size.width" title="size.width">#</a> <a href="size.attributes.get.html">size.attributes.get</a> <a href="size.attributes.set.html">size.attributes.set</a> <a href="size.attributes.idl.set.zero.html">size.attributes.idl.set.zero</a> <a href="size.attributes.idl.html">size.attributes.idl</a> </span>
           attribute unsigned long <a href="#dom-canvas-height" title="dom-canvas-height">height</a>;<span class="testrefs kw-none" id="testrefs.size.height"> <a href="#testrefs.size.height" title="size.height">#</a> <a href="size.attributes.get.html">size.attributes.get</a> <a href="size.attributes.set.html">size.attributes.set</a> <a href="size.attributes.idl.set.zero.html">size.attributes.idl.set.zero</a> <a href="size.attributes.idl.html">size.attributes.idl</a> </span>
  ...
  are the element's <a href="#fallback-content">fallback content</a><span class="testrefs kw-none" id="testrefs.fallback"> <a href="#testrefs.fallback" title="fallback">#</a> <a href="fallback.basic.html">fallback.basic</a> <a href="fallback.multiple.html">fallback.multiple</a> <a href="fallback.nested.html">fallback.nested</a> </span>.</p>
  ...
  values<span class="testrefs kw-must" id="testrefs.size.nonnegativeinteger"> <a href="#testrefs.size.nonnegativeinteger" title="size.nonnegativeinteger">#</a> <a href="size.attributes.parse.zero.html">size.attributes.parse.zero</a> <a href="size.attributes.parse.empty.html">size.attributes.parse.empty</a> <a href="size.attributes.parse.onlyspace.html">size.attributes.parse.onlyspace</a> <a href="size.attributes.parse.space.html">size.attributes.parse.space</a> <a href="size.attributes.parse.whitespace.html">size.attributes.parse.whitespace</a> <a href="size.attributes.parse.plus.html">size.attributes.parse.plus</a> <a href="size.attributes.parse.minus.html">size.attributes.parse.minus</a> <a href="size.attributes.parse.octal.html">size.attributes.parse.octal</a> <a href="size.attributes.parse.hex.html">size.attributes.parse.hex</a> <a href="size.attributes.parse.exp.html">size.attributes.parse.exp</a> <a href="size.attributes.parse.decimal.html">size.attributes.parse.decimal</a> <a href="size.attributes.parse.percent.html">size.attributes.parse.percent</a> <a href="size.attributes.parse.em.html">size.attributes.parse.em</a> <a href="size.attributes.parse.junk.html">size.attributes.parse.junk</a> <a href="size.attributes.parse.trailingjunk.html">size.attributes.parse.trailingjunk</a> <a href="size.attributes.setAttribute.zero.html">size.attributes.setAttribute.zero</a> <a href="size.attributes.setAttribute.empty.html">size.attributes.setAttribute.empty</a> <a href="size.attributes.setAttribute.onlyspace.html">size.attributes.setAttribute.onlyspace</a> <a href="size.attributes.setAttribute.space.html">size.attributes.setAttribute.space</a> <a href="size.attributes.setAttribute.whitespace.html">size.attributes.setAttribute.whitespace</a> <a href="size.attributes.setAttribute.plus.html">size.attributes.setAttribute.plus</a> <a href="size.attributes.setAttribute.minus.html">size.attributes.setAttribute.minus</a> <a href="size.attributes.setAttribute.octal.html">size.attributes.setAttribute.octal</a> <a href="size.attributes.setAttribute.hex.html">size.attributes.setAttribute.hex</a> <a href="size.attributes.setAttribute.exp.html">size.attributes.setAttribute.exp</a> <a href="size.attributes.setAttribute.decimal.html">size.attributes.setAttribute.decimal</a> <a href="size.attributes.setAttribute.percent.html">size.attributes.setAttribute.percent</a> <a href="size.attributes.setAttribute.em.html">size.attributes.setAttribute.em</a> <a href="size.attributes.setAttribute.junk.html">size.attributes.setAttribute.junk</a> <a href="size.attributes.setAttribute.trailingjunk.html">size.attributes.setAttribute.trailingjunk</a> </span>. If an attribute is missing<span class="testrefs kw-must" id="testrefs.size.missing"> <a href="#testrefs.size.missing" title="size.missing">#</a> <a href="size.attributes.default.html">size.attributes.default</a> <a href="size.attributes.removed.html">size.attributes.removed</a> </span>, or if parsing its value returns
  an error<span class="testrefs kw-must" id="testrefs.size.error"> <a href="#testrefs.size.error" title="size.error">#</a> <a href="size.attributes.parse.empty.html">size.attributes.parse.empty</a> <a href="size.attributes.parse.onlyspace.html">size.attributes.parse.onlyspace</a> <a href="size.attributes.parse.minus.html">size.attributes.parse.minus</a> <a href="size.attributes.parse.junk.html">size.attributes.parse.junk</a> <a href="size.attributes.setAttribute.empty.html">size.attributes.setAttribute.empty</a> <a href="size.attributes.setAttribute.onlyspace.html">size.attributes.setAttribute.onlyspace</a> <a href="size.attributes.setAttribute.minus.html">size.attributes.setAttribute.minus</a> <a href="size.attributes.setAttribute.junk.html">size.attributes.setAttribute.junk</a> </span>, then the default value must be used instead.</span> The
  ...
  attribute defaults to 150<span class="testrefs kw-none" id="testrefs.size.default"> <a href="#testrefs.size.default" title="size.default">#</a> <a href="size.attributes.default.html">size.attributes.default</a> </span>.</p>
  ...
  size<span class="testrefs kw-none" id="testrefs.size.css"> <a href="#testrefs.size.css" title="size.css">#</a> <a href="size.attributes.style.html">size.attributes.style</a> </span>.</p>
  ...
  dimensions<span class="testrefs kw-must" id="testrefs.initial.reset"> <a href="#testrefs.initial.reset" title="initial.reset">#</a> <a href="initial.reset.different.html">initial.reset.different</a> <a href="initial.reset.same.html">initial.reset.same</a> <a href="initial.reset.path.html">initial.reset.path</a> <a href="initial.reset.clip.html">initial.reset.clip</a> <a href="initial.reset.transform.html">initial.reset.transform</a> <a href="initial.reset.gradient.html">initial.reset.gradient</a> <a href="initial.reset.pattern.html">initial.reset.pattern</a> <a href="security.reset.html">security.reset</a> <a href="initial.reset.2dstate.html">initial.reset.2dstate</a> </span>.</p>

  <p>When the canvas is initialized, its bitmap must be cleared to
  transparent black<span class="testrefs kw-must" id="testrefs.initial.colour"> <a href="#testrefs.initial.colour" title="initial.colour">#</a> <a href="initial.colour.html">initial.colour</a> </span>.</p>
  ...
  attributes of the same name<span class="testrefs kw-must" id="testrefs.size.reflect"> <a href="#testrefs.size.reflect" title="size.reflect">#</a> <a href="size.attributes.reflect.setidl.html">size.attributes.reflect.setidl</a> <a href="size.attributes.reflect.setidlzero.html">size.attributes.reflect.setidlzero</a> <a href="size.attributes.reflect.setcontent.html">size.attributes.reflect.setcontent</a> </span>.</p>
  ...
  <code><a href="#canvasrenderingcontext2d">CanvasRenderingContext2D</a></code><span class="testrefs kw-must" id="testrefs.context.2d"> <a href="#testrefs.context.2d" title="context.2d">#</a> <a href="2d.getcontext.exists.html">2d.getcontext.exists</a> </span>. Other specifications may
  ...
  <p>When the UA is passed an empty string<span class="testrefs kw-must" id="testrefs.context.empty"> <a href="#testrefs.context.empty" title="context.empty">#</a> <a href="context.emptystring.html">context.emptystring</a> </span> or a string specifying a
  context that it does not support<span class="testrefs kw-must" id="testrefs.context.unrecognised"> <a href="#testrefs.context.unrecognised" title="context.unrecognised">#</a> <a href="context.unrecognised.badname.html">context.unrecognised.badname</a> <a href="context.unrecognised.badsuffix.html">context.unrecognised.badsuffix</a> <a href="context.unrecognised.nullsuffix.html">context.unrecognised.nullsuffix</a> <a href="context.unrecognised.unicode.html">context.unrecognised.unicode</a> </span>, then it must return null. String
  comparisons must be <a href="#case-sensitive">case-sensitive</a><span class="testrefs kw-must" id="testrefs.context.casesensitive"> <a href="#testrefs.context.casesensitive" title="context.casesensitive">#</a> <a href="context.casesensitive.html">context.casesensitive</a> </span>.</p>
  ...
  as a PNG file<span class="testrefs kw-must" id="testrefs.toDataURL.noarguments"> <a href="#testrefs.toDataURL.noarguments" title="toDataURL.noarguments">#</a> <a href="toDataURL.default.html">toDataURL.default</a> <a href="toDataURL.nocontext.html">toDataURL.nocontext</a> </span>. <a href="#refsPNG">[PNG]</a></p>
  ...
  string &quot;<code title="">data:,</code>&quot;<span class="testrefs kw-must" id="testrefs.toDataURL.zerosize"> <a href="#testrefs.toDataURL.zerosize" title="toDataURL.zerosize">#</a> <a href="toDataURL.zerosize.html">toDataURL.zerosize</a> </span>. (This is the shortest <code title="">data:</code> URL; it represents the empty string in a <code title="">text/plain</code> resource.)</p>
  ...
  <var title="">type</var><span class="testrefs kw-must" id="testrefs.toDataURL.witharguments"> <a href="#testrefs.toDataURL.witharguments" title="toDataURL.witharguments">#</a> <a href="toDataURL.png.html">toDataURL.png</a> </span>. The possible values are <a href="#mime-type" title="MIME   type">MIME types</a> with no parameters, for example
  ...
  to create the <code title="">data:</code> URL<span class="testrefs kw-must" id="testrefs.toDataURL.noalpha"> <a href="#testrefs.toDataURL.noalpha" title="toDataURL.noalpha">#</a> <a href="toDataURL.jpeg.alpha.html">toDataURL.jpeg.alpha</a> </span>.</p>

  <p>Only support for <code>image/png</code> is required<span class="testrefs kw-required" id="testrefs.toDataURL.png"> <a href="#testrefs.toDataURL.png" title="toDataURL.png">#</a> <a href="toDataURL.png.html">toDataURL.png</a> <a href="toDataURL.png.primarycolours.html">toDataURL.png.primarycolours</a> <a href="toDataURL.png.complexcolours.html">toDataURL.png.complexcolours</a> </span>. User agents
  may support other types. If the user agent does not support the
  requested type, it must return the image using the PNG format<span class="testrefs kw-must" id="testrefs.toDataURL.unrecognised"> <a href="#testrefs.toDataURL.unrecognised" title="toDataURL.unrecognised">#</a> <a href="toDataURL.bogustype.html">toDataURL.bogustype</a> <a href="toDataURL.unrecognised.html">toDataURL.unrecognised</a> </span>.</p>
  ...
  support that type and before creating the <code title="">data:</code> URL<span class="testrefs kw-must" id="testrefs.toDataURL.lowercase"> <a href="#testrefs.toDataURL.lowercase" title="toDataURL.lowercase">#</a> <a href="toDataURL.lowercase.ascii.html">toDataURL.lowercase.ascii</a> <a href="toDataURL.lowercase.unicode.html">toDataURL.lowercase.unicode</a> </span>.</p>
  ...
  <table><thead><tr><th> Type </th><th> Other arguments
   </th></tr></thead><tbody><tr><td> image/jpeg<span class="testrefs kw-none" id="testrefs.toDataURL.jpeg"> <a href="#testrefs.toDataURL.jpeg" title="toDataURL.jpeg">#</a> <a href="toDataURL.jpeg.primarycolours.html">toDataURL.jpeg.primarycolours</a> <a href="toDataURL.jpeg.alpha.html">toDataURL.jpeg.alpha</a> </span>
     </td><td> The second argument<span class="impl">, if it</span> is a
     number between 0.0 and 1.0<span class="impl">, must be</span>
     treated as the desired quality level<span class="testrefs kw-must" id="testrefs.toDataURL.jpeg.quality"> <a href="#testrefs.toDataURL.jpeg.quality" title="toDataURL.jpeg.quality">#</a> <a href="toDataURL.jpeg.quality.basic.html">toDataURL.jpeg.quality.basic</a> </span>. <span class="impl">If it is
     not a number<span class="testrefs kw-must" id="testrefs.toDataURL.jpeg.nan"> <a href="#testrefs.toDataURL.jpeg.nan" title="toDataURL.jpeg.nan">#</a> <a href="toDataURL.jpeg.quality.notnumber.html">toDataURL.jpeg.quality.notnumber</a> </span> or is outside that range<span class="testrefs kw-must" id="testrefs.toDataURL.jpeg.range"> <a href="#testrefs.toDataURL.jpeg.range" title="toDataURL.jpeg.range">#</a> <a href="toDataURL.jpeg.quality.outsiderange.html">toDataURL.jpeg.quality.outsiderange</a> </span>, the user agent must use
  ...
  to raise an exception<span class="testrefs kw-must" id="testrefs.toDataURL.arguments"> <a href="#testrefs.toDataURL.arguments" title="toDataURL.arguments">#</a> <a href="toDataURL.arguments.1.html">toDataURL.arguments.1</a> <a href="toDataURL.arguments.2.html">toDataURL.arguments.2</a> <a href="toDataURL.arguments.3.html">toDataURL.arguments.3</a> </span>. A future version of this specification will
  ...
  must return the same object<span class="testrefs kw-must" id="testrefs.context.2d.unique"> <a href="#testrefs.context.2d.unique" title="context.2d.unique">#</a> <a href="2d.getcontext.unique.html">2d.getcontext.unique</a> <a href="2d.getcontext.shared.html">2d.getcontext.shared</a> </span>.</p>
  ...
  <var title="">x</var> values increasing when going right, and <var title="">y</var> values increasing when going down<span class="testrefs kw-none" id="testrefs.2d.coordinatespace"> <a href="#testrefs.2d.coordinatespace" title="2d.coordinatespace">#</a> <a href="2d.coordinatespace.html">2d.coordinatespace</a> </span>.</p>

  <pre class="idl">interface <dfn id="canvasrenderingcontext2d">CanvasRenderingContext2D</dfn><span class="testrefs kw-none" id="testrefs.context.2d.type"> <a href="#testrefs.context.2d.type" title="context.2d.type">#</a> </span> {

  // back-reference to the canvas
  readonly<span class="testrefs kw-none" id="testrefs.2d.canvas.attribute"> <a href="#testrefs.2d.canvas.attribute" title="2d.canvas.attribute">#</a> <a href="2d.canvas.readonly.html">2d.canvas.readonly</a> </span> attribute <a href="#htmlcanvaselement">HTMLCanvasElement</a> <a href="#dom-context-2d-canvas" title="dom-context-2d-canvas">canvas</a>;
...
interface <dfn id="canvaspixelarray">CanvasPixelArray</dfn> {
  ...
  context paints on<span class="testrefs kw-must" id="testrefs.2d.canvas"> <a href="#testrefs.2d.canvas" title="2d.canvas">#</a> <a href="2d.canvas.reference.html">2d.canvas.reference</a> </span>.</p>
  ...
  color is specified<span class="testrefs kw-none" id="testrefs.2d.currentColor.onset"> <a href="#testrefs.2d.currentColor.onset" title="2d.currentColor.onset">#</a> <a href="2d.fillStyle.parse.current.basic.html">2d.fillStyle.parse.current.basic</a> <a href="2d.fillStyle.parse.current.changed.html">2d.fillStyle.parse.current.changed</a> </span> (e.g. when the appropriate attribute is set, or
  ...
  fully opaque black<span class="testrefs kw-none" id="testrefs.2d.currentColor.outofdoc"> <a href="#testrefs.2d.currentColor.outofdoc" title="2d.currentColor.outofdoc">#</a> <a href="2d.fillStyle.parse.current.removed.html">2d.fillStyle.parse.current.removed</a> </span>. <a href="#refsCSSCOLOR">[CSSCOLOR]</a></p>
  ...
  <ul class="brief"><li>The current <a href="#transformations" title="dom-context-2d-transformation">transformation matrix</a><span class="testrefs kw-none" id="testrefs.2d.state.transformation"> <a href="#testrefs.2d.state.transformation" title="2d.state.transformation">#</a> <a href="2d.state.saverestore.transformation.html">2d.state.saverestore.transformation</a> </span>.</li>
   <li>The current <a href="#clipping-region">clipping region</a><span class="testrefs kw-none" id="testrefs.2d.state.clip"> <a href="#testrefs.2d.state.clip" title="2d.state.clip">#</a> <a href="2d.state.saverestore.clip.html">2d.state.saverestore.clip</a> </span>.</li>
   <li>The current values of the following attributes: <code title="dom-context-2d-strokeStyle"><a href="#dom-context-2d-strokestyle">strokeStyle</a></code><span class="testrefs kw-none" id="testrefs.2d.state.strokeStyle"> <a href="#testrefs.2d.state.strokeStyle" title="2d.state.strokeStyle">#</a> <a href="2d.state.saverestore.strokeStyle.html">2d.state.saverestore.strokeStyle</a> </span>, <code title="dom-context-2d-fillStyle"><a href="#dom-context-2d-fillstyle">fillStyle</a></code><span class="testrefs kw-none" id="testrefs.2d.state.fillStyle"> <a href="#testrefs.2d.state.fillStyle" title="2d.state.fillStyle">#</a> <a href="2d.state.saverestore.fillStyle.html">2d.state.saverestore.fillStyle</a> </span>, <code title="dom-context-2d-globalAlpha"><a href="#dom-context-2d-globalalpha">globalAlpha</a></code><span class="testrefs kw-none" id="testrefs.2d.state.globalAlpha"> <a href="#testrefs.2d.state.globalAlpha" title="2d.state.globalAlpha">#</a> <a href="2d.state.saverestore.globalAlpha.html">2d.state.saverestore.globalAlpha</a> </span>, <code title="dom-context-2d-lineWidth"><a href="#dom-context-2d-linewidth">lineWidth</a></code><span class="testrefs kw-none" id="testrefs.2d.state.lineWidth"> <a href="#testrefs.2d.state.lineWidth" title="2d.state.lineWidth">#</a> <a href="2d.state.saverestore.lineWidth.html">2d.state.saverestore.lineWidth</a> </span>, <code title="dom-context-2d-lineCap"><a href="#dom-context-2d-linecap">lineCap</a></code><span class="testrefs kw-none" id="testrefs.2d.state.lineCap"> <a href="#testrefs.2d.state.lineCap" title="2d.state.lineCap">#</a> <a href="2d.state.saverestore.lineCap.html">2d.state.saverestore.lineCap</a> </span>, <code title="dom-context-2d-lineJoin"><a href="#dom-context-2d-linejoin">lineJoin</a></code><span class="testrefs kw-none" id="testrefs.2d.state.lineJoin"> <a href="#testrefs.2d.state.lineJoin" title="2d.state.lineJoin">#</a> <a href="2d.state.saverestore.lineJoin.html">2d.state.saverestore.lineJoin</a> </span>, <code title="dom-context-2d-miterLimit"><a href="#dom-context-2d-miterlimit">miterLimit</a></code><span class="testrefs kw-none" id="testrefs.2d.state.miterLimit"> <a href="#testrefs.2d.state.miterLimit" title="2d.state.miterLimit">#</a> <a href="2d.state.saverestore.miterLimit.html">2d.state.saverestore.miterLimit</a> </span>, <code title="dom-context-2d-shadowOffsetX"><a href="#dom-context-2d-shadowoffsetx">shadowOffsetX</a></code><span class="testrefs kw-none" id="testrefs.2d.state.shadowOffsetX"> <a href="#testrefs.2d.state.shadowOffsetX" title="2d.state.shadowOffsetX">#</a> <a href="2d.state.saverestore.shadowOffsetX.html">2d.state.saverestore.shadowOffsetX</a> </span>, <code title="dom-context-2d-shadowOffsetY"><a href="#dom-context-2d-shadowoffsety">shadowOffsetY</a></code><span class="testrefs kw-none" id="testrefs.2d.state.shadowOffsetY"> <a href="#testrefs.2d.state.shadowOffsetY" title="2d.state.shadowOffsetY">#</a> <a href="2d.state.saverestore.shadowOffsetY.html">2d.state.saverestore.shadowOffsetY</a> </span>, <code title="dom-context-2d-shadowBlur"><a href="#dom-context-2d-shadowblur">shadowBlur</a></code><span class="testrefs kw-none" id="testrefs.2d.state.shadowBlur"> <a href="#testrefs.2d.state.shadowBlur" title="2d.state.shadowBlur">#</a> <a href="2d.state.saverestore.shadowBlur.html">2d.state.saverestore.shadowBlur</a> </span>, <code title="dom-context-2d-shadowColor"><a href="#dom-context-2d-shadowcolor">shadowColor</a></code><span class="testrefs kw-none" id="testrefs.2d.state.shadowColor"> <a href="#testrefs.2d.state.shadowColor" title="2d.state.shadowColor">#</a> <a href="2d.state.saverestore.shadowColor.html">2d.state.saverestore.shadowColor</a> </span>, <code title="dom-context-2d-globalCompositeOperation"><a href="#dom-context-2d-globalcompositeoperation">globalCompositeOperation</a></code><span class="testrefs kw-none" id="testrefs.2d.state.globalCompositeOperation"> <a href="#testrefs.2d.state.globalCompositeOperation" title="2d.state.globalCompositeOperation">#</a> <a href="2d.state.saverestore.globalCompositeOperation.html">2d.state.saverestore.globalCompositeOperation</a> </span>, <code title="dom-context-2d-font"><a href="#dom-context-2d-font">font</a></code><span class="testrefs kw-none" id="testrefs.2d.state.font"> <a href="#testrefs.2d.state.font" title="2d.state.font">#</a> <a href="2d.state.saverestore.font.html">2d.state.saverestore.font</a> </span>, <code title="dom-context-2d-textAlign"><a href="#dom-context-2d-textalign">textAlign</a></code><span class="testrefs kw-none" id="testrefs.2d.state.textAlign"> <a href="#testrefs.2d.state.textAlign" title="2d.state.textAlign">#</a> <a href="2d.state.saverestore.textAlign.html">2d.state.saverestore.textAlign</a> </span>, <code title="dom-context-2d-textBaseline"><a href="#dom-context-2d-textbaseline">textBaseline</a></code><span class="testrefs kw-none" id="testrefs.2d.state.textBaseline"> <a href="#testrefs.2d.state.textBaseline" title="2d.state.textBaseline">#</a> <a href="2d.state.saverestore.textBaseline.html">2d.state.saverestore.textBaseline</a> </span>.</li>
  </ul><p class="note">The current path<span class="testrefs kw-none" id="testrefs.2d.state.path"> <a href="#testrefs.2d.state.path" title="2d.state.path">#</a> <a href="2d.state.saverestore.path.html">2d.state.saverestore.path</a> </span> and the current bitmap<span class="testrefs kw-none" id="testrefs.2d.state.bitmap"> <a href="#testrefs.2d.state.bitmap" title="2d.state.bitmap">#</a> <a href="2d.state.saverestore.bitmap.html">2d.state.saverestore.bitmap</a> </span> are not part
  ...
  drawing state stack<span class="testrefs kw-must" id="testrefs.2d.state.save"> <a href="#testrefs.2d.state.save" title="2d.state.save">#</a> <a href="2d.state.saverestore.stack.html">2d.state.saverestore.stack</a> <a href="2d.state.saverestore.stackdepth.html">2d.state.saverestore.stackdepth</a> </span>.</p>
  ...
  drawing state it describes<span class="testrefs kw-must" id="testrefs.2d.state.restore"> <a href="#testrefs.2d.state.restore" title="2d.state.restore">#</a> <a href="2d.state.saverestore.stack.html">2d.state.saverestore.stack</a> <a href="2d.state.saverestore.stackdepth.html">2d.state.saverestore.stackdepth</a> </span>. If there is no saved state, the method
  must do nothing<span class="testrefs kw-must" id="testrefs.2d.state.restore.underflow"> <a href="#testrefs.2d.state.restore.underflow" title="2d.state.restore.underflow">#</a> <a href="2d.state.saverestore.underflow.html">2d.state.saverestore.underflow</a> </span>.</p>
...
> But how would it interact with normal calls to ctx.restore()?
  ...
  initially be the identity transform<span class="testrefs kw-must" id="testrefs.2d.transformation.initial"> <a href="#testrefs.2d.transformation.initial" title="2d.transformation.initial">#</a> </span>. It may then be adjusted using
  the transformation methods.</p>

  <p>The transformations must be performed in reverse order<span class="testrefs kw-must" id="testrefs.2d.transformation.order"> <a href="#testrefs.2d.transformation.order" title="2d.transformation.order">#</a> <a href="2d.transformation.order.html">2d.transformation.order</a> </span>. For
  ...
  transformation matrix<span class="testrefs kw-must" id="testrefs.2d.transformation.scale"> <a href="#testrefs.2d.transformation.scale" title="2d.transformation.scale">#</a> <a href="2d.transformation.scale.basic.html">2d.transformation.scale.basic</a> <a href="2d.transformation.scale.zero.html">2d.transformation.scale.zero</a> <a href="2d.transformation.scale.negative.html">2d.transformation.scale.negative</a> <a href="2d.transformation.scale.large.html">2d.transformation.scale.large</a> </span>. The <var title="">x</var> argument represents
  the scale factor in the horizontal direction and the <var title="">y</var> argument represents the scale factor in the
  vertical direction. The factors are multiples<span class="testrefs kw-none" id="testrefs.2d.transformation.scale.multiple"> <a href="#testrefs.2d.transformation.scale.multiple" title="2d.transformation.scale.multiple">#</a> <a href="2d.transformation.scale.multiple.html">2d.transformation.scale.multiple</a> </span>.</p>
  ...
  matrix<span class="testrefs kw-must" id="testrefs.2d.transformation.rotate"> <a href="#testrefs.2d.transformation.rotate" title="2d.transformation.rotate">#</a> <a href="2d.transformation.rotate.zero.html">2d.transformation.rotate.zero</a> <a href="2d.transformation.rotate.wrap.html">2d.transformation.rotate.wrap</a> <a href="2d.transformation.rotate.wrapnegative.html">2d.transformation.rotate.wrapnegative</a> </span>. The <var title="">angle</var> argument represents a
  clockwise rotation angle<span class="testrefs kw-none" id="testrefs.2d.transformation.rotate.direction"> <a href="#testrefs.2d.transformation.rotate.direction" title="2d.transformation.rotate.direction">#</a> <a href="2d.transformation.rotate.direction.html">2d.transformation.rotate.direction</a> </span> expressed in radians<span class="testrefs kw-none" id="testrefs.2d.transformation.rotate.radians"> <a href="#testrefs.2d.transformation.rotate.radians" title="2d.transformation.rotate.radians">#</a> <a href="2d.transformation.rotate.radians.html">2d.transformation.rotate.radians</a> </span>.</p>
  ...
  transformation matrix<span class="testrefs kw-must" id="testrefs.2d.transformation.translate"> <a href="#testrefs.2d.transformation.translate" title="2d.transformation.translate">#</a> <a href="2d.transformation.translate.basic.html">2d.transformation.translate.basic</a> </span>. The <var title="">x</var> argument represents
  ...
  <table class="matrix"><tbody><tr><td><var title="">m11</var></td>
  ...
  transform to the identity matrix<span class="testrefs kw-must" id="testrefs.2d.transformation.setTransform.identity"> <a href="#testrefs.2d.transformation.setTransform.identity" title="2d.transformation.setTransform.identity">#</a> <a href="2d.transformation.setTransform.multiple.html">2d.transformation.setTransform.multiple</a> </span>, and then invoke the <code><a href="#dom-context-2d-transform" title="dom-context-2d-transform">transform</a>(<var title="">m11</var>, <var title="">m12</var>, <var title="">m21</var>, <var title="">m22</var>, <var title="">dx</var>,
  <var title="">dy</var>)</code> method with the same arguments<span class="testrefs kw-must" id="testrefs.2d.transformation.setTransform"> <a href="#testrefs.2d.transformation.setTransform" title="2d.transformation.setTransform">#</a> <a href="2d.transformation.setTransform.skewed.html">2d.transformation.setTransform.skewed</a> </span>.</p>
  ...
  attributes, <code title="dom-context-2d-globalAlpha"><a href="#dom-context-2d-globalalpha">globalAlpha</a></code> and <code title="dom-context-2d-globalCompositeOperation"><a href="#dom-context-2d-globalcompositeoperation">globalCompositeOperation</a></code><span class="testrefs kw-none" id="testrefs.2d.composite.operation"> <a href="#testrefs.2d.composite.operation" title="2d.composite.operation">#</a> <a href="2d.composite.operation.get.html">2d.composite.operation.get</a> </span>.</p>
  ...
  attribute gives an alpha value that is applied to shapes<span class="testrefs kw-none" id="testrefs.2d.composite.globalAlpha.shape"> <a href="#testrefs.2d.composite.globalAlpha.shape" title="2d.composite.globalAlpha.shape">#</a> <a href="2d.composite.globalAlpha.fill.html">2d.composite.globalAlpha.fill</a> </span> and images<span class="testrefs kw-none" id="testrefs.2d.composite.globalAlpha.image"> <a href="#testrefs.2d.composite.globalAlpha.image" title="2d.composite.globalAlpha.image">#</a> <a href="2d.composite.globalAlpha.image.html">2d.composite.globalAlpha.image</a> <a href="2d.composite.globalAlpha.canvas.html">2d.composite.globalAlpha.canvas</a> <a href="2d.composite.globalAlpha.imagepattern.html">2d.composite.globalAlpha.imagepattern</a> <a href="2d.composite.globalAlpha.canvaspattern.html">2d.composite.globalAlpha.canvaspattern</a> </span>
  ...
  values, the attribute must retain its previous value<span class="testrefs kw-must" id="testrefs.2d.composite.globalAlpha.range"> <a href="#testrefs.2d.composite.globalAlpha.range" title="2d.composite.globalAlpha.range">#</a> <a href="2d.composite.globalAlpha.range.html">2d.composite.globalAlpha.range</a> <a href="2d.composite.globalAlpha.invalid.html">2d.composite.globalAlpha.invalid</a> </span>. When the
  ...
  initially have the value 1.0<span class="testrefs kw-must" id="testrefs.2d.composite.globalAlpha.default"> <a href="#testrefs.2d.composite.globalAlpha.default" title="2d.composite.globalAlpha.default">#</a> <a href="2d.composite.globalAlpha.default.html">2d.composite.globalAlpha.default</a> </span>.</p>
  ...
  attribute sets how shapes<span class="testrefs kw-none" id="testrefs.2d.composite.operation.shape"> <a href="#testrefs.2d.composite.operation.shape" title="2d.composite.operation.shape">#</a> </span> and images<span class="testrefs kw-none" id="testrefs.2d.composite.operation.image"> <a href="#testrefs.2d.composite.operation.image" title="2d.composite.operation.image">#</a> </span> are drawn onto the existing
  ...
  <dl><dt><dfn id="gcop-source-atop" title="gcop-source-atop"><code>source-atop</code></dfn></dt><span class="testrefs kw-none" id="testrefs.2d.composite.source-atop"> <a href="#testrefs.2d.composite.source-atop" title="2d.composite.source-atop">#</a> <a href="2d.composite.solid.source-atop.html">2d.composite.solid.source-atop</a> <a href="2d.composite.transparent.source-atop.html">2d.composite.transparent.source-atop</a> <a href="2d.composite.image.source-atop.html">2d.composite.image.source-atop</a> <a href="2d.composite.canvas.source-atop.html">2d.composite.canvas.source-atop</a> <a href="2d.composite.clip.source-atop.html">2d.composite.clip.source-atop</a> </span>
   ...
   <dt><dfn id="gcop-source-in" title="gcop-source-in"><code>source-in</code></dfn></dt><span class="testrefs kw-none" id="testrefs.2d.composite.source-in"> <a href="#testrefs.2d.composite.source-in" title="2d.composite.source-in">#</a> <a href="2d.composite.solid.source-in.html">2d.composite.solid.source-in</a> <a href="2d.composite.transparent.source-in.html">2d.composite.transparent.source-in</a> <a href="2d.composite.image.source-in.html">2d.composite.image.source-in</a> <a href="2d.composite.canvas.source-in.html">2d.composite.canvas.source-in</a> <a href="2d.composite.uncovered.fill.source-in.html">2d.composite.uncovered.fill.source-in</a> <a href="2d.composite.uncovered.image.source-in.html">2d.composite.uncovered.image.source-in</a> <a href="2d.composite.uncovered.nocontext.source-in.html">2d.composite.uncovered.nocontext.source-in</a> <a href="2d.composite.uncovered.pattern.source-in.html">2d.composite.uncovered.pattern.source-in</a> <a href="2d.composite.clip.source-in.html">2d.composite.clip.source-in</a> </span>
   ...
   <dt><dfn id="gcop-source-out" title="gcop-source-out"><code>source-out</code></dfn></dt><span class="testrefs kw-none" id="testrefs.2d.composite.source-out"> <a href="#testrefs.2d.composite.source-out" title="2d.composite.source-out">#</a> <a href="2d.composite.solid.source-out.html">2d.composite.solid.source-out</a> <a href="2d.composite.transparent.source-out.html">2d.composite.transparent.source-out</a> <a href="2d.composite.image.source-out.html">2d.composite.image.source-out</a> <a href="2d.composite.canvas.source-out.html">2d.composite.canvas.source-out</a> <a href="2d.composite.uncovered.fill.source-out.html">2d.composite.uncovered.fill.source-out</a> <a href="2d.composite.uncovered.image.source-out.html">2d.composite.uncovered.image.source-out</a> <a href="2d.composite.uncovered.nocontext.source-out.html">2d.composite.uncovered.nocontext.source-out</a> <a href="2d.composite.uncovered.pattern.source-out.html">2d.composite.uncovered.pattern.source-out</a> <a href="2d.composite.clip.source-out.html">2d.composite.clip.source-out</a> </span>
   ...
   <dt><dfn id="gcop-source-over" title="gcop-source-over"><code>source-over</code></dfn> (default)</dt><span class="testrefs kw-none" id="testrefs.2d.composite.source-over"> <a href="#testrefs.2d.composite.source-over" title="2d.composite.source-over">#</a> <a href="2d.composite.solid.source-over.html">2d.composite.solid.source-over</a> <a href="2d.composite.transparent.source-over.html">2d.composite.transparent.source-over</a> <a href="2d.composite.image.source-over.html">2d.composite.image.source-over</a> <a href="2d.composite.canvas.source-over.html">2d.composite.canvas.source-over</a> <a href="2d.composite.clip.source-over.html">2d.composite.clip.source-over</a> </span>
   ...
   <dt><dfn id="gcop-destination-atop" title="gcop-destination-atop"><code>destination-atop</code></dfn></dt><span class="testrefs kw-none" id="testrefs.2d.composite.destination-atop"> <a href="#testrefs.2d.composite.destination-atop" title="2d.composite.destination-atop">#</a> <a href="2d.composite.solid.destination-atop.html">2d.composite.solid.destination-atop</a> <a href="2d.composite.transparent.destination-atop.html">2d.composite.transparent.destination-atop</a> <a href="2d.composite.image.destination-atop.html">2d.composite.image.destination-atop</a> <a href="2d.composite.canvas.destination-atop.html">2d.composite.canvas.destination-atop</a> <a href="2d.composite.uncovered.fill.destination-atop.html">2d.composite.uncovered.fill.destination-atop</a> <a href="2d.composite.uncovered.image.destination-atop.html">2d.composite.uncovered.image.destination-atop</a> <a href="2d.composite.uncovered.nocontext.destination-atop.html">2d.composite.uncovered.nocontext.destination-atop</a> <a href="2d.composite.uncovered.pattern.destination-atop.html">2d.composite.uncovered.pattern.destination-atop</a> <a href="2d.composite.clip.destination-atop.html">2d.composite.clip.destination-atop</a> </span>
   ...
   <dt><dfn id="gcop-destination-in" title="gcop-destination-in"><code>destination-in</code></dfn></dt><span class="testrefs kw-none" id="testrefs.2d.composite.destination-in"> <a href="#testrefs.2d.composite.destination-in" title="2d.composite.destination-in">#</a> <a href="2d.composite.solid.destination-in.html">2d.composite.solid.destination-in</a> <a href="2d.composite.transparent.destination-in.html">2d.composite.transparent.destination-in</a> <a href="2d.composite.image.destination-in.html">2d.composite.image.destination-in</a> <a href="2d.composite.canvas.destination-in.html">2d.composite.canvas.destination-in</a> <a href="2d.composite.uncovered.fill.destination-in.html">2d.composite.uncovered.fill.destination-in</a> <a href="2d.composite.uncovered.image.destination-in.html">2d.composite.uncovered.image.destination-in</a> <a href="2d.composite.uncovered.nocontext.destination-in.html">2d.composite.uncovered.nocontext.destination-in</a> <a href="2d.composite.uncovered.pattern.destination-in.html">2d.composite.uncovered.pattern.destination-in</a> <a href="2d.composite.clip.destination-in.html">2d.composite.clip.destination-in</a> </span>
   ...
   <dt><dfn id="gcop-destination-out" title="gcop-destination-out"><code>destination-out</code></dfn></dt><span class="testrefs kw-none" id="testrefs.2d.composite.destination-out"> <a href="#testrefs.2d.composite.destination-out" title="2d.composite.destination-out">#</a> <a href="2d.composite.solid.destination-out.html">2d.composite.solid.destination-out</a> <a href="2d.composite.transparent.destination-out.html">2d.composite.transparent.destination-out</a> <a href="2d.composite.image.destination-out.html">2d.composite.image.destination-out</a> <a href="2d.composite.canvas.destination-out.html">2d.composite.canvas.destination-out</a> <a href="2d.composite.clip.destination-out.html">2d.composite.clip.destination-out</a> </span>
   ...
   <dt><dfn id="gcop-destination-over" title="gcop-destination-over"><code>destination-over</code></dfn></dt><span class="testrefs kw-none" id="testrefs.2d.composite.destination-over"> <a href="#testrefs.2d.composite.destination-over" title="2d.composite.destination-over">#</a> <a href="2d.composite.solid.destination-over.html">2d.composite.solid.destination-over</a> <a href="2d.composite.transparent.destination-over.html">2d.composite.transparent.destination-over</a> <a href="2d.composite.image.destination-over.html">2d.composite.image.destination-over</a> <a href="2d.composite.canvas.destination-over.html">2d.composite.canvas.destination-over</a> <a href="2d.composite.clip.destination-over.html">2d.composite.clip.destination-over</a> </span>
...
-->
   ...
   <dt><dfn id="gcop-copy" title="gcop-copy"><code>copy</code></dfn></dt><span class="testrefs kw-none" id="testrefs.2d.composite.copy"> <a href="#testrefs.2d.composite.copy" title="2d.composite.copy">#</a> <a href="2d.composite.solid.copy.html">2d.composite.solid.copy</a> <a href="2d.composite.transparent.copy.html">2d.composite.transparent.copy</a> <a href="2d.composite.image.copy.html">2d.composite.image.copy</a> <a href="2d.composite.canvas.copy.html">2d.composite.canvas.copy</a> <a href="2d.composite.uncovered.fill.copy.html">2d.composite.uncovered.fill.copy</a> <a href="2d.composite.uncovered.image.copy.html">2d.composite.uncovered.image.copy</a> <a href="2d.composite.uncovered.nocontext.copy.html">2d.composite.uncovered.nocontext.copy</a> <a href="2d.composite.uncovered.pattern.copy.html">2d.composite.uncovered.pattern.copy</a> <a href="2d.composite.clip.copy.html">2d.composite.clip.copy</a> </span>
   ...
   <dt><dfn id="gcop-xor" title="gcop-xor"><code>xor</code></dfn></dt><span class="testrefs kw-none" id="testrefs.2d.composite.xor"> <a href="#testrefs.2d.composite.xor" title="2d.composite.xor">#</a> <a href="2d.composite.solid.xor.html">2d.composite.solid.xor</a> <a href="2d.composite.transparent.xor.html">2d.composite.transparent.xor</a> <a href="2d.composite.image.xor.html">2d.composite.image.xor</a> <a href="2d.composite.canvas.xor.html">2d.composite.canvas.xor</a> <a href="2d.composite.clip.xor.html">2d.composite.clip.xor</a> </span>
  ...
  above<span class="testrefs kw-must" id="testrefs.2d.composite.operation.exact"> <a href="#testrefs.2d.composite.operation.exact" title="2d.composite.operation.exact">#</a> <a href="2d.composite.operation.nullsuffix.html">2d.composite.operation.nullsuffix</a> </span>.</p>
  ...
  (e.g. <var title="">A</var> over <var title="">B</var>)<span class="testrefs kw-must" id="testrefs.2d.composite.operation.porterduff"> <a href="#testrefs.2d.composite.operation.porterduff" title="2d.composite.operation.porterduff">#</a> </span>. <a href="#refsPORTERDUFF">[PORTERDUFF]</a></p>
  ...
  <code>source-over</code><span class="testrefs kw-must" id="testrefs.2d.composite.operation.default"> <a href="#testrefs.2d.composite.operation.default" title="2d.composite.operation.default">#</a> <a href="2d.composite.operation.default.html">2d.composite.operation.default</a> </span>.</p>
  ...
  must be returned<span class="testrefs kw-must" id="testrefs.2d.colours.getcolour"> <a href="#testrefs.2d.colours.getcolour" title="2d.colours.getcolour">#</a> <a href="2d.fillStyle.get.solid.html">2d.fillStyle.get.solid</a> <a href="2d.fillStyle.get.semitransparent.html">2d.fillStyle.get.semitransparent</a> <a href="2d.fillStyle.get.transparent.html">2d.fillStyle.get.transparent</a> </span>. Otherwise, if it is not a color but a
  <code><a href="#canvasgradient">CanvasGradient</a></code><span class="testrefs kw-must" id="testrefs.2d.gradient.object"> <a href="#testrefs.2d.gradient.object" title="2d.gradient.object">#</a> <a href="2d.gradient.object.compare.html">2d.gradient.object.compare</a> </span> or <code><a href="#canvaspattern">CanvasPattern</a></code><span class="testrefs kw-must" id="testrefs.2d.pattern.object"> <a href="#testrefs.2d.pattern.object" title="2d.pattern.object">#</a> </span>, then the
  ...
  string is a lowercase six-digit hex value<span class="testrefs kw-none" id="testrefs.2d.serializecolour.solid"> <a href="#testrefs.2d.serializecolour.solid" title="2d.serializecolour.solid">#</a> <a href="2d.fillStyle.get.solid.html">2d.fillStyle.get.solid</a> </span>, prefixed with a &quot;#&quot;
  ...
  than 1.0, and the string is the color value in the CSS <code title="">rgba()</code> functional-notation format<span class="testrefs kw-none" id="testrefs.2d.serializecolour.transparent"> <a href="#testrefs.2d.serializecolour.transparent" title="2d.serializecolour.transparent">#</a> <a href="2d.fillStyle.get.semitransparent.html">2d.fillStyle.get.semitransparent</a> <a href="2d.fillStyle.get.transparent.html">2d.fillStyle.get.transparent</a> </span>: the literal
  ...
  initially have the string value <code title="">#000000</code><span class="testrefs kw-must" id="testrefs.2d.colours.default"> <a href="#testrefs.2d.colours.default" title="2d.colours.default">#</a> <a href="2d.fillStyle.default.html">2d.fillStyle.default</a> <a href="2d.strokeStyle.default.html">2d.strokeStyle.default</a> </span>.</p>
  ...
  interpolated<span class="testrefs kw-must" id="testrefs.2d.gradient.interpolate.linear"> <a href="#testrefs.2d.gradient.interpolate.linear" title="2d.gradient.interpolate.linear">#</a> <a href="2d.gradient.interpolate.solid.html">2d.gradient.interpolate.solid</a> <a href="2d.gradient.interpolate.colour.html">2d.gradient.interpolate.colour</a> <a href="2d.gradient.interpolate.alpha.html">2d.gradient.interpolate.alpha</a> <a href="2d.gradient.interpolate.vertical.html">2d.gradient.interpolate.vertical</a> <a href="2d.gradient.interpolate.multiple.html">2d.gradient.interpolate.multiple</a> </span> over the RGBA space without premultiplying the alpha
  value<span class="testrefs kw-must" id="testrefs.2d.gradient.interpolate.alpha"> <a href="#testrefs.2d.gradient.interpolate.alpha" title="2d.gradient.interpolate.alpha">#</a> <a href="2d.gradient.interpolate.colouralpha.html">2d.gradient.interpolate.colouralpha</a> </span> to find the color to use at that offset. Before the first
  stop, the color must be the color of the first stop<span class="testrefs kw-must" id="testrefs.2d.gradient.outside.first"> <a href="#testrefs.2d.gradient.outside.first" title="2d.gradient.outside.first">#</a> <a href="2d.gradient.interpolate.outside.html">2d.gradient.interpolate.outside</a> </span>. After the last
  stop, the color must be the color of the last stop<span class="testrefs kw-must" id="testrefs.2d.gradient.outside.last"> <a href="#testrefs.2d.gradient.outside.last" title="2d.gradient.outside.last">#</a> <a href="2d.gradient.interpolate.outside.html">2d.gradient.interpolate.outside</a> </span>. When there are
  no stops, the gradient is transparent black<span class="testrefs kw-none" id="testrefs.2d.gradient.empty"> <a href="#testrefs.2d.gradient.empty" title="2d.gradient.empty">#</a> <a href="2d.gradient.empty.html">2d.gradient.empty</a> </span>.</span></p>
  ...
  <code><a href="#index_size_err">INDEX_SIZE_ERR</a></code> exception must be raised<span class="testrefs kw-must" id="testrefs.2d.gradient.invalidoffset"> <a href="#testrefs.2d.gradient.invalidoffset" title="2d.gradient.invalidoffset">#</a> <a href="2d.gradient.object.invalidoffset.html">2d.gradient.object.invalidoffset</a> </span>. If the <var title="">color</var> cannot be parsed as a CSS color, then a
  <code><a href="#syntax_err">SYNTAX_ERR</a></code> exception must be raised<span class="testrefs kw-must" id="testrefs.2d.gradient.invalidcolour"> <a href="#testrefs.2d.gradient.invalidcolour" title="2d.gradient.invalidcolour">#</a> <a href="2d.gradient.object.invalidcolour.html">2d.gradient.object.invalidcolour</a> </span>. Otherwise, the
  ...
  &lt;color&gt; value<span class="testrefs kw-must" id="testrefs.2d.gradient.update"> <a href="#testrefs.2d.gradient.update" title="2d.gradient.update">#</a> <a href="2d.gradient.object.update.html">2d.gradient.object.update</a> </span>. If multiple stops are added at the same offset
  ...
  ignored)<span class="testrefs kw-must" id="testrefs.2d.gradient.interpolate.overlap"> <a href="#testrefs.2d.gradient.interpolate.overlap" title="2d.gradient.interpolate.overlap">#</a> <a href="2d.gradient.interpolate.overlap.html">2d.gradient.interpolate.overlap</a> <a href="2d.gradient.interpolate.overlap2.html">2d.gradient.interpolate.overlap2</a> </span>.</p>
  ...
  <code><a href="#not_supported_err">NOT_SUPPORTED_ERR</a></code> exception<span class="testrefs kw-must" id="testrefs.2d.gradient.linear.nonfinite"> <a href="#testrefs.2d.gradient.linear.nonfinite" title="2d.gradient.linear.nonfinite">#</a> <a href="2d.gradient.linear.nonfinite.html">2d.gradient.linear.nonfinite</a> </span>. Otherwise, the method must
  return a linear <code><a href="#canvasgradient">CanvasGradient</a></code> initialized with the
  specified line<span class="testrefs kw-must" id="testrefs.2d.gradient.linear.return"> <a href="#testrefs.2d.gradient.linear.return" title="2d.gradient.linear.return">#</a> <a href="2d.gradient.object.return.html">2d.gradient.object.return</a> </span>.</p>
  ...
  extrapolation</a> described above)<span class="testrefs kw-must" id="testrefs.2d.gradient.linear.rendering"> <a href="#testrefs.2d.gradient.linear.rendering" title="2d.gradient.linear.rendering">#</a> </span>. The points in the linear
  ...
  matrix</a> when rendering<span class="testrefs kw-must" id="testrefs.2d.gradient.linear.transform"> <a href="#testrefs.2d.gradient.linear.transform" title="2d.gradient.linear.transform">#</a> <a href="2d.gradient.linear.transform.1.html">2d.gradient.linear.transform.1</a> <a href="2d.gradient.linear.transform.2.html">2d.gradient.linear.transform.2</a> <a href="2d.gradient.linear.transform.3.html">2d.gradient.linear.transform.3</a> </span>.</p>

  <p>If <span title=""><var title="">x0</var> = <var title="">x1</var></span> and <span title=""><var title="">y0</var> = <var title="">y1</var></span>, then
  the linear gradient must paint nothing<span class="testrefs kw-must" id="testrefs.2d.gradient.linear.zerosize"> <a href="#testrefs.2d.gradient.linear.zerosize" title="2d.gradient.linear.zerosize">#</a> <a href="2d.gradient.interpolate.zerosize.html">2d.gradient.interpolate.zerosize</a> </span>.</p>
  ...
  <ol><li><p>If <span title=""><var title="">x<sub>0</sub></var> = <var title="">x<sub>1</sub></var></span> and <span title=""><var title="">y<sub>0</sub></var> = <var title="">y<sub>1</sub></var></span> and <span title=""><var title="">r<sub>0</sub></var> = <var title="">r<sub>1</sub></var></span>, then the radial gradient must
   paint nothing<span class="testrefs kw-must" id="testrefs.2d.gradient.radial.equal"> <a href="#testrefs.2d.gradient.radial.equal" title="2d.gradient.radial.equal">#</a> <a href="2d.gradient.radial.equal.html">2d.gradient.radial.equal</a> </span>. Abort these steps.</p></li>
  ...
  filling effects requires that they be drawn<span class="testrefs kw-must" id="testrefs.2d.gradient.extent"> <a href="#testrefs.2d.gradient.extent" title="2d.gradient.extent">#</a> </span>.</p>
  ...
  transformation matrix</a> when rendering<span class="testrefs kw-must" id="testrefs.2d.gradient.radial.transform"> <a href="#testrefs.2d.gradient.radial.transform" title="2d.gradient.radial.transform">#</a> <a href="2d.gradient.radial.transform.1.html">2d.gradient.radial.transform.1</a> <a href="2d.gradient.radial.transform.2.html">2d.gradient.radial.transform.2</a> <a href="2d.gradient.radial.transform.3.html">2d.gradient.radial.transform.3</a> </span>.</p>
...
-->
  ...
  must not affect the pattern<span class="testrefs kw-must" id="testrefs.2d.pattern.modify"> <a href="#testrefs.2d.pattern.modify" title="2d.pattern.modify">#</a> <a href="2d.pattern.modify.image1.html">2d.pattern.modify.image1</a> <a href="2d.pattern.modify.image2.html">2d.pattern.modify.image2</a> <a href="2d.pattern.modify.canvas1.html">2d.pattern.modify.canvas1</a> <a href="2d.pattern.modify.canvas2.html">2d.pattern.modify.canvas2</a> </span>. The second argument must be a string
  ...
  specified, <code title="">repeat</code> must be assumed<span class="testrefs kw-must" id="testrefs.2d.pattern.missing"> <a href="#testrefs.2d.pattern.missing" title="2d.pattern.missing">#</a> <a href="2d.pattern.repeat.empty.html">2d.pattern.repeat.empty</a> <a href="2d.pattern.repeat.null.html">2d.pattern.repeat.null</a> </span>. If an
  unrecognized value is given, then the user agent must raise a
  <code><a href="#syntax_err">SYNTAX_ERR</a></code> exception<span class="testrefs kw-must" id="testrefs.2d.pattern.unrecognised"> <a href="#testrefs.2d.pattern.unrecognised" title="2d.pattern.unrecognised">#</a> <a href="2d.pattern.repeat.undefined.html">2d.pattern.repeat.undefined</a> <a href="2d.pattern.repeat.unrecognised.html">2d.pattern.repeat.unrecognised</a> </span>. User agents must recognize the
  four values described above exactly (e.g. they must not do case
  folding)<span class="testrefs kw-must" id="testrefs.2d.pattern.exact"> <a href="#testrefs.2d.pattern.exact" title="2d.pattern.exact">#</a> <a href="2d.pattern.repeat.case.html">2d.pattern.repeat.case</a> <a href="2d.pattern.repeat.nullsuffix.html">2d.pattern.repeat.nullsuffix</a> </span>. The method must return a <code><a href="#canvaspattern">CanvasPattern</a></code> object
  suitably initialized<span class="testrefs kw-must" id="testrefs.2d.pattern.return"> <a href="#testrefs.2d.pattern.return" title="2d.pattern.return">#</a> <a href="2d.pattern.basic.type.html">2d.pattern.basic.type</a> </span>.</p>
  ...
  <code><a href="#type_mismatch_err">TYPE_MISMATCH_ERR</a></code> exception<span class="testrefs kw-must" id="testrefs.2d.pattern.wrongtype"> <a href="#testrefs.2d.pattern.wrongtype" title="2d.pattern.wrongtype">#</a> <a href="2d.pattern.image.undefined.html">2d.pattern.image.undefined</a> <a href="2d.pattern.image.null.html">2d.pattern.image.null</a> <a href="2d.pattern.image.string.html">2d.pattern.image.string</a> </span>.</p>
  <!-- drawImage() has an equivalent paragraph -->

  <p>If the <var title="">image</var> argument is an
  <code><a href="#htmlimageelement">HTMLImageElement</a></code> object whose <code title="dom-img-complete"><a href="#dom-img-complete">complete</a></code> attribute is false<span class="testrefs kw-must" id="testrefs.2d.pattern.incomplete.image"> <a href="#testrefs.2d.pattern.incomplete.image" title="2d.pattern.incomplete.image">#</a> <a href="2d.pattern.image.incomplete.html">2d.pattern.image.incomplete</a> <a href="2d.pattern.image.broken.html">2d.pattern.image.broken</a> </span>, or
  ...
  <code title="dom-media-HAVE_NOTHING"><a href="#dom-media-have_nothing">HAVE_NOTHING</a></code> or <code title="dom-media-HAVE_METADATA"><a href="#dom-media-have_metadata">HAVE_METADATA</a></code><span class="testrefs kw-must" id="testrefs.2d.pattern.incomplete.video"> <a href="#testrefs.2d.pattern.incomplete.video" title="2d.pattern.incomplete.video">#</a> </span>, then the
  ...
  exception<span class="testrefs kw-must" id="testrefs.2d.pattern.zerocanvas"> <a href="#testrefs.2d.pattern.zerocanvas" title="2d.pattern.zerocanvas">#</a> <a href="2d.pattern.basic.zerocanvas.html">2d.pattern.basic.zerocanvas</a> </span>.</p>
  <!-- drawImage() has an equivalent paragraph -->
  ...
  animation<span class="testrefs kw-none" id="testrefs.2d.pattern.animated.image"> <a href="#testrefs.2d.pattern.animated.image" title="2d.pattern.animated.image">#</a> <a href="2d.pattern.animated.gif.html">2d.pattern.animated.gif</a> </span>.</p>
  <!-- drawImage() has an equivalent paragraph -->
  ...
  playback position</a> must be used as the source image<span class="testrefs kw-must" id="testrefs.2d.pattern.animated.video"> <a href="#testrefs.2d.pattern.animated.video" title="2d.pattern.animated.video">#</a> </span>, and the
  ...
  correction has been applied)<span class="testrefs kw-must" id="testrefs.2d.pattern.video.size"> <a href="#testrefs.2d.pattern.video.size" title="2d.pattern.video.size">#</a> </span>.</p>
  <!-- drawImage() has an equivalent paragraph -->
  ...
  attribute gives the width of lines, in coordinate space units<span class="testrefs kw-none" id="testrefs.2d.lineWidth"> <a href="#testrefs.2d.lineWidth" title="2d.lineWidth">#</a> <a href="2d.line.width.basic.html">2d.line.width.basic</a> <a href="2d.line.width.transformed.html">2d.line.width.transformed</a> <a href="2d.line.width.scaledefault.html">2d.line.width.scaledefault</a> </span>. On
  getting, it must return the current value<span class="testrefs kw-must" id="testrefs.2d.lineWidth.get"> <a href="#testrefs.2d.lineWidth.get" title="2d.lineWidth.get">#</a> <a href="2d.line.width.valid.html">2d.line.width.valid</a> </span>. On setting, zero,
  negative, infinite, and NaN values must be ignored, leaving the
  value unchanged<span class="testrefs kw-must" id="testrefs.2d.lineWidth.invalid"> <a href="#testrefs.2d.lineWidth.invalid" title="2d.lineWidth.invalid">#</a> <a href="2d.line.width.invalid.html">2d.line.width.invalid</a> </span>; other values must change the current value to the
  new value<span class="testrefs kw-must" id="testrefs.2d.lineWidth.set"> <a href="#testrefs.2d.lineWidth.set" title="2d.lineWidth.set">#</a> <a href="2d.line.width.valid.html">2d.line.width.valid</a> </span>.</p>
  ...
  initially have the value <code>1.0</code><span class="testrefs kw-must" id="testrefs.2d.lineWidth.default"> <a href="#testrefs.2d.lineWidth.default" title="2d.lineWidth.default">#</a> <a href="2d.line.defaults.html">2d.line.defaults</a> </span>.</p>
  ...
  lines<span class="testrefs kw-none" id="testrefs.2d.lineCap.end"> <a href="#testrefs.2d.lineCap.end" title="2d.lineCap.end">#</a> <a href="2d.line.cap.open.html">2d.line.cap.open</a> <a href="2d.line.cap.closed.html">2d.line.cap.closed</a> </span>. The three valid values are <code>butt</code>,
  ...
  added)<span class="testrefs kw-none" id="testrefs.2d.lineCap.butt"> <a href="#testrefs.2d.lineCap.butt" title="2d.lineCap.butt">#</a> <a href="2d.line.cap.butt.html">2d.line.cap.butt</a> </span>. The <code>round</code> value means that a semi-circle with
  the diameter equal to the width of the line must then be added on to
  the end of the line<span class="testrefs kw-must" id="testrefs.2d.lineCap.round"> <a href="#testrefs.2d.lineCap.round" title="2d.lineCap.round">#</a> <a href="2d.line.cap.round.html">2d.line.cap.round</a> </span>. The <code>square</code> value means that a
  ...
  direction of the line, must be added at the end of each line<span class="testrefs kw-must" id="testrefs.2d.lineCap.square"> <a href="#testrefs.2d.lineCap.square" title="2d.lineCap.square">#</a> <a href="2d.line.cap.square.html">2d.line.cap.square</a> </span>.</p>

  <p>On getting, it must return the current value<span class="testrefs kw-must" id="testrefs.2d.lineCap.get"> <a href="#testrefs.2d.lineCap.get" title="2d.lineCap.get">#</a> <a href="2d.line.cap.valid.html">2d.line.cap.valid</a> </span>. On setting, if the
  new value is one of the literal strings <code>butt</code>,
  <code>round</code>, and <code>square</code>, then the current value
  must be changed to the new value<span class="testrefs kw-must" id="testrefs.2d.lineCap.set"> <a href="#testrefs.2d.lineCap.set" title="2d.lineCap.set">#</a> <a href="2d.line.cap.valid.html">2d.line.cap.valid</a> </span>; other values must ignored, leaving
  the value unchanged<span class="testrefs kw-must" id="testrefs.2d.lineCap.invalid"> <a href="#testrefs.2d.lineCap.invalid" title="2d.lineCap.invalid">#</a> <a href="2d.line.cap.invalid.html">2d.line.cap.invalid</a> </span>.</p>
  ...
  initially have the value <code>butt</code><span class="testrefs kw-must" id="testrefs.2d.lineCap.default"> <a href="#testrefs.2d.lineCap.default" title="2d.lineCap.default">#</a> <a href="2d.line.defaults.html">2d.line.defaults</a> </span>.</p>
  ...
  <p>On getting, it must return the current value<span class="testrefs kw-must" id="testrefs.2d.lineJoin.get"> <a href="#testrefs.2d.lineJoin.get" title="2d.lineJoin.get">#</a> <a href="2d.line.join.valid.html">2d.line.join.valid</a> </span>. On setting, if the
  new value is one of the literal strings <code>bevel</code>,
  <code>round</code>, and <code>miter</code>, then the current value
  must be changed to the new value<span class="testrefs kw-must" id="testrefs.2d.lineJoin.set"> <a href="#testrefs.2d.lineJoin.set" title="2d.lineJoin.set">#</a> <a href="2d.line.join.valid.html">2d.line.join.valid</a> </span>; other values must be ignored,
  leaving the value unchanged<span class="testrefs kw-must" id="testrefs.2d.lineJoin.invalid"> <a href="#testrefs.2d.lineJoin.invalid" title="2d.lineJoin.invalid">#</a> <a href="2d.line.join.invalid.html">2d.line.join.invalid</a> </span>.</p>
  ...
  initially have the value <code>miter</code><span class="testrefs kw-must" id="testrefs.2d.lineJoin.default"> <a href="#testrefs.2d.lineJoin.default" title="2d.lineJoin.default">#</a> <a href="2d.line.defaults.html">2d.line.defaults</a> </span>.</p>

  <hr><p>A join exists at any point in a subpath shared by two consecutive
  lines<span class="testrefs kw-none" id="testrefs.2d.lineJoin.joins"> <a href="#testrefs.2d.lineJoin.joins" title="2d.lineJoin.joins">#</a> <a href="2d.line.join.open.html">2d.line.join.open</a> <a href="2d.line.join.parallel.html">2d.line.join.parallel</a> </span>. When a subpath is closed, then a join also exists at its
  first point (equivalent to its last point) connecting the first and
  last lines in the subpath<span class="testrefs kw-none" id="testrefs.2d.lineJoin.joinclosed"> <a href="#testrefs.2d.lineJoin.joinclosed" title="2d.lineJoin.joinclosed">#</a> <a href="2d.line.join.closed.html">2d.line.join.closed</a> </span>.</p>
  ...
  point, must be rendered at all joins<span class="testrefs kw-must" id="testrefs.2d.lineJoin.common"> <a href="#testrefs.2d.lineJoin.common" title="2d.lineJoin.common">#</a> <a href="2d.line.join.bevel.html">2d.line.join.bevel</a> </span>. The <code title="dom-context-2d-lineJoin"><a href="#dom-context-2d-linejoin">lineJoin</a></code> attribute controls
  ...
  rendered at joins<span class="testrefs kw-none" id="testrefs.2d.lineJoin.bevel"> <a href="#testrefs.2d.lineJoin.bevel" title="2d.lineJoin.bevel">#</a> <a href="2d.line.join.bevel.html">2d.line.join.bevel</a> </span>.</p>
  ...
  rendered at joins<span class="testrefs kw-must" id="testrefs.2d.lineJoin.round"> <a href="#testrefs.2d.lineJoin.round" title="2d.lineJoin.round">#</a> <a href="2d.line.join.round.html">2d.line.join.round</a> </span>.</p>
  ...
  intersect without going over the miter length<span class="testrefs kw-must" id="testrefs.2d.lineJoin.miter"> <a href="#testrefs.2d.lineJoin.miter" title="2d.lineJoin.miter">#</a> <a href="2d.line.join.miter.html">2d.line.join.miter</a> <a href="2d.line.miter.exceeded.html">2d.line.miter.exceeded</a> <a href="2d.line.miter.acute.html">2d.line.miter.acute</a> <a href="2d.line.miter.obtuse.html">2d.line.miter.obtuse</a> <a href="2d.line.miter.rightangle.html">2d.line.miter.rightangle</a> <a href="2d.line.miter.lineedge.html">2d.line.miter.lineedge</a> <a href="2d.line.miter.within.html">2d.line.miter.within</a> </span>.</p>
  ...
  be rendered<span class="testrefs kw-must" id="testrefs.2d.lineJoin.miterLimit"> <a href="#testrefs.2d.lineJoin.miterLimit" title="2d.lineJoin.miterLimit">#</a> <a href="2d.line.miter.exceeded.html">2d.line.miter.exceeded</a> <a href="2d.line.miter.acute.html">2d.line.miter.acute</a> <a href="2d.line.miter.obtuse.html">2d.line.miter.obtuse</a> </span>.</p>
  ...
  attribute. On getting, it must return the current value<span class="testrefs kw-must" id="testrefs.2d.miterLimit.get"> <a href="#testrefs.2d.miterLimit.get" title="2d.miterLimit.get">#</a> <a href="2d.line.miter.valid.html">2d.line.miter.valid</a> </span>. On setting,
  zero, negative, infinite, and NaN values must be ignored, leaving
  the value unchanged<span class="testrefs kw-must" id="testrefs.2d.miterLimit.invalid"> <a href="#testrefs.2d.miterLimit.invalid" title="2d.miterLimit.invalid">#</a> <a href="2d.line.miter.invalid.html">2d.line.miter.invalid</a> </span>; other values must change the current value to
  the new value<span class="testrefs kw-must" id="testrefs.2d.miterLimit.set"> <a href="#testrefs.2d.miterLimit.set" title="2d.miterLimit.set">#</a> <a href="2d.line.miter.valid.html">2d.line.miter.valid</a> </span>.</p>
  ...
  initially have the value <code>10.0</code><span class="testrefs kw-must" id="testrefs.2d.miterLimit.default"> <a href="#testrefs.2d.miterLimit.default" title="2d.miterLimit.default">#</a> <a href="2d.line.defaults.html">2d.line.defaults</a> </span>.</p>
...
> allowing whatever behavior the graphics library has.)
  ...
  initially must be fully-transparent black<span class="testrefs kw-must" id="testrefs.2d.shadow.color.initial"> <a href="#testrefs.2d.shadow.color.initial" title="2d.shadow.color.initial">#</a> <a href="2d.shadow.attributes.shadowColor.initial.html">2d.shadow.attributes.shadowColor.initial</a> </span>.</p>

  <p>On getting, the <a href="#serialization-of-a-color" title="serialization of a   color">serialization of the color</a> must be returned<span class="testrefs kw-must" id="testrefs.2d.shadow.color.get"> <a href="#testrefs.2d.shadow.color.get" title="2d.shadow.color.get">#</a> <a href="2d.shadow.attributes.shadowColor.valid.html">2d.shadow.attributes.shadowColor.valid</a> </span>.</p>

  <p>On setting, the new value must be parsed as a CSS &lt;color&gt;
  value and the color assigned<span class="testrefs kw-must" id="testrefs.2d.shadow.color.set"> <a href="#testrefs.2d.shadow.color.set" title="2d.shadow.color.set">#</a> <a href="2d.shadow.attributes.shadowColor.valid.html">2d.shadow.attributes.shadowColor.valid</a> </span>. If the value is not a valid color,
  then it must be ignored, and the attribute must retain its previous
  value<span class="testrefs kw-must" id="testrefs.2d.shadow.color.invalid"> <a href="#testrefs.2d.shadow.color.invalid" title="2d.shadow.color.invalid">#</a> <a href="2d.shadow.attributes.shadowColor.invalid.html">2d.shadow.attributes.shadowColor.invalid</a> </span>. <a href="#refsCSSCOLOR">[CSSCOLOR]</a></p>
  ...
  initially have the value <code>0</code><span class="testrefs kw-must" id="testrefs.2d.shadow.offset.initial"> <a href="#testrefs.2d.shadow.offset.initial" title="2d.shadow.offset.initial">#</a> <a href="2d.shadow.attributes.shadowOffset.initial.html">2d.shadow.attributes.shadowOffset.initial</a> </span>.</p>

  <p>On getting, they must return their current value<span class="testrefs kw-must" id="testrefs.2d.shadow.offset.get"> <a href="#testrefs.2d.shadow.offset.get" title="2d.shadow.offset.get">#</a> <a href="2d.shadow.attributes.shadowOffset.valid.html">2d.shadow.attributes.shadowOffset.valid</a> </span>. On setting, the
  attribute being set must be set to the new value<span class="testrefs kw-must" id="testrefs.2d.shadow.offset.set"> <a href="#testrefs.2d.shadow.offset.set" title="2d.shadow.offset.set">#</a> <a href="2d.shadow.attributes.shadowOffset.valid.html">2d.shadow.attributes.shadowOffset.valid</a> </span>, except if the
  value is infinite or NaN, in which case the new value must be
  ignored<span class="testrefs kw-must" id="testrefs.2d.shadow.offset.invalid"> <a href="#testrefs.2d.shadow.offset.invalid" title="2d.shadow.offset.invalid">#</a> <a href="2d.shadow.attributes.shadowOffset.invalid.html">2d.shadow.attributes.shadowOffset.invalid</a> </span>.</p>
  ...
  initially have the value <code>0</code><span class="testrefs kw-must" id="testrefs.2d.shadow.blur.initial"> <a href="#testrefs.2d.shadow.blur.initial" title="2d.shadow.blur.initial">#</a> <a href="2d.shadow.attributes.shadowBlur.initial.html">2d.shadow.attributes.shadowBlur.initial</a> </span>.</p>

  <p>On getting, the attribute must return its current value<span class="testrefs kw-must" id="testrefs.2d.shadow.blur.get"> <a href="#testrefs.2d.shadow.blur.get" title="2d.shadow.blur.get">#</a> <a href="2d.shadow.attributes.shadowBlur.initial.html">2d.shadow.attributes.shadowBlur.initial</a> <a href="2d.shadow.attributes.shadowBlur.valid.html">2d.shadow.attributes.shadowBlur.valid</a> </span>. On
  setting the attribute must be set to the new value<span class="testrefs kw-must" id="testrefs.2d.shadow.blur.set"> <a href="#testrefs.2d.shadow.blur.set" title="2d.shadow.blur.set">#</a> <a href="2d.shadow.attributes.shadowBlur.valid.html">2d.shadow.attributes.shadowBlur.valid</a> </span>, except if the
  value is negative, infinite or NaN, in which case the new value must
  be ignored<span class="testrefs kw-must" id="testrefs.2d.shadow.blur.invalid"> <a href="#testrefs.2d.shadow.blur.invalid" title="2d.shadow.blur.invalid">#</a> <a href="2d.shadow.attributes.shadowBlur.invalid.html">2d.shadow.attributes.shadowBlur.invalid</a> </span>.</p>
  ...
  non-zero<span class="testrefs kw-none" id="testrefs.2d.shadow.enable"> <a href="#testrefs.2d.shadow.enable" title="2d.shadow.enable">#</a> <a href="2d.shadow.enable.off.1.html">2d.shadow.enable.off.1</a> <a href="2d.shadow.enable.off.2.html">2d.shadow.enable.off.2</a> <a href="2d.shadow.enable.blur.html">2d.shadow.enable.blur</a> <a href="2d.shadow.enable.x.html">2d.shadow.enable.x</a> <a href="2d.shadow.enable.y.html">2d.shadow.enable.y</a> </span>.</p>

  <p><a href="#when-shadows-are-drawn">When shadows are drawn</a>, they must be rendered as follows<span class="testrefs kw-must" id="testrefs.2d.shadow.render"> <a href="#testrefs.2d.shadow.render" title="2d.shadow.render">#</a> <a href="2d.shadow.enable.off.1.html">2d.shadow.enable.off.1</a> <a href="2d.shadow.enable.off.2.html">2d.shadow.enable.off.2</a> <a href="2d.shadow.enable.blur.html">2d.shadow.enable.blur</a> <a href="2d.shadow.enable.x.html">2d.shadow.enable.x</a> <a href="2d.shadow.enable.y.html">2d.shadow.enable.y</a> <a href="2d.shadow.offset.positiveX.html">2d.shadow.offset.positiveX</a> <a href="2d.shadow.offset.negativeX.html">2d.shadow.offset.negativeX</a> <a href="2d.shadow.offset.positiveY.html">2d.shadow.offset.positiveY</a> <a href="2d.shadow.offset.negativeY.html">2d.shadow.offset.negativeY</a> <a href="2d.shadow.outside.html">2d.shadow.outside</a> <a href="2d.shadow.clip.1.html">2d.shadow.clip.1</a> <a href="2d.shadow.clip.2.html">2d.shadow.clip.2</a> <a href="2d.shadow.clip.3.html">2d.shadow.clip.3</a> <a href="2d.shadow.stroke.basic.html">2d.shadow.stroke.basic</a> <a href="2d.shadow.stroke.cap.1.html">2d.shadow.stroke.cap.1</a> <a href="2d.shadow.stroke.cap.2.html">2d.shadow.stroke.cap.2</a> <a href="2d.shadow.stroke.join.1.html">2d.shadow.stroke.join.1</a> <a href="2d.shadow.stroke.join.2.html">2d.shadow.stroke.join.2</a> <a href="2d.shadow.stroke.join.3.html">2d.shadow.stroke.join.3</a> <a href="2d.shadow.image.basic.html">2d.shadow.image.basic</a> <a href="2d.shadow.image.transparent.1.html">2d.shadow.image.transparent.1</a> <a href="2d.shadow.image.transparent.2.html">2d.shadow.image.transparent.2</a> <a href="2d.shadow.image.alpha.html">2d.shadow.image.alpha</a> <a href="2d.shadow.image.section.html">2d.shadow.image.section</a> <a href="2d.shadow.image.scale.html">2d.shadow.image.scale</a> <a href="2d.shadow.canvas.basic.html">2d.shadow.canvas.basic</a> <a href="2d.shadow.canvas.transparent.1.html">2d.shadow.canvas.transparent.1</a> <a href="2d.shadow.canvas.transparent.2.html">2d.shadow.canvas.transparent.2</a> <a href="2d.shadow.canvas.alpha.html">2d.shadow.canvas.alpha</a> <a href="2d.shadow.pattern.basic.html">2d.shadow.pattern.basic</a> <a href="2d.shadow.pattern.transparent.1.html">2d.shadow.pattern.transparent.1</a> <a href="2d.shadow.pattern.transparent.2.html">2d.shadow.pattern.transparent.2</a> <a href="2d.shadow.pattern.alpha.html">2d.shadow.pattern.alpha</a> <a href="2d.shadow.gradient.basic.html">2d.shadow.gradient.basic</a> <a href="2d.shadow.gradient.transparent.1.html">2d.shadow.gradient.transparent.1</a> <a href="2d.shadow.gradient.transparent.2.html">2d.shadow.gradient.transparent.2</a> <a href="2d.shadow.gradient.alpha.html">2d.shadow.gradient.alpha</a> <a href="2d.shadow.transform.1.html">2d.shadow.transform.1</a> <a href="2d.shadow.transform.2.html">2d.shadow.transform.2</a> <a href="2d.shadow.blur.low.html">2d.shadow.blur.low</a> <a href="2d.shadow.blur.high.html">2d.shadow.blur.high</a> <a href="2d.shadow.alpha.1.html">2d.shadow.alpha.1</a> <a href="2d.shadow.alpha.2.html">2d.shadow.alpha.2</a> <a href="2d.shadow.alpha.3.html">2d.shadow.alpha.3</a> <a href="2d.shadow.alpha.4.html">2d.shadow.alpha.4</a> <a href="2d.shadow.alpha.5.html">2d.shadow.alpha.5</a> <a href="2d.shadow.composite.1.html">2d.shadow.composite.1</a> <a href="2d.shadow.composite.2.html">2d.shadow.composite.2</a> <a href="2d.shadow.composite.3.html">2d.shadow.composite.3</a> </span>:</p>
  ...
  coordinates<span class="testrefs kw-must" id="testrefs.2d.rect.transform"> <a href="#testrefs.2d.rect.transform" title="2d.rect.transform">#</a> </span>, which form the path that must then be closed to get the
  specified rectangle<span class="testrefs kw-must" id="testrefs.2d.rect.closed"> <a href="#testrefs.2d.rect.closed" title="2d.rect.closed">#</a> </span>: <span title="">(<var title="">x</var>, <var title="">y</var>)</span>, <span title="">(<span title=""><var title="">x</var>+<var title="">w</var></span>, <var title="">y</var>)</span>,
  ...
  rectangular area using the <code title="dom-context-2d-fillStyle"><a href="#dom-context-2d-fillstyle">fillStyle</a></code><span class="testrefs kw-must" id="testrefs.2d.fillRect"> <a href="#testrefs.2d.fillRect" title="2d.fillRect">#</a> <a href="2d.fillRect.basic.html">2d.fillRect.basic</a> <a href="2d.fillRect.path.html">2d.fillRect.path</a> <a href="2d.fillRect.zero.html">2d.fillRect.zero</a> <a href="2d.fillRect.negative.html">2d.fillRect.negative</a> <a href="2d.fillRect.transform.html">2d.fillRect.transform</a> <a href="2d.fillRect.clip.html">2d.fillRect.clip</a> <a href="2d.fillRect.shadow.html">2d.fillRect.shadow</a> </span>. If either height
  ...
  appropriate) <code title="dom-context-2d-miterLimit"><a href="#dom-context-2d-miterlimit">miterLimit</a></code> attributes<span class="testrefs kw-must" id="testrefs.2d.strokeRect"> <a href="#testrefs.2d.strokeRect" title="2d.strokeRect">#</a> <a href="2d.strokeRect.basic.html">2d.strokeRect.basic</a> <a href="2d.strokeRect.path.html">2d.strokeRect.path</a> <a href="2d.strokeRect.zero.1.html">2d.strokeRect.zero.1</a> <a href="2d.strokeRect.zero.2.html">2d.strokeRect.zero.2</a> <a href="2d.strokeRect.zero.3.html">2d.strokeRect.zero.3</a> <a href="2d.strokeRect.zero.4.html">2d.strokeRect.zero.4</a> <a href="2d.strokeRect.zero.5.html">2d.strokeRect.zero.5</a> <a href="2d.strokeRect.negative.html">2d.strokeRect.negative</a> <a href="2d.strokeRect.transform.html">2d.strokeRect.transform</a> <a href="2d.strokeRect.globalalpha.html">2d.strokeRect.globalalpha</a> <a href="2d.strokeRect.globalcomposite.html">2d.strokeRect.globalcomposite</a> <a href="2d.strokeRect.clip.html">2d.strokeRect.clip</a> <a href="2d.strokeRect.shadow.html">2d.strokeRect.shadow</a> </span>. If
  ...
  <p>Initially, the context's path must have zero subpaths<span class="testrefs kw-must" id="testrefs.2d.path.initial"> <a href="#testrefs.2d.path.initial" title="2d.path.initial">#</a> <a href="2d.path.initial.html">2d.path.initial</a> </span>.</p>
  ...
  matrix</a> as they are added<span class="testrefs kw-must" id="testrefs.2d.path.transformation"> <a href="#testrefs.2d.path.transformation" title="2d.path.transformation">#</a> <a href="2d.path.arc.scale.1.html">2d.path.arc.scale.1</a> <a href="2d.path.stroke.scale1.html">2d.path.stroke.scale1</a> <a href="2d.path.stroke.scale2.html">2d.path.stroke.scale2</a> <a href="2d.path.stroke.skew.html">2d.path.stroke.skew</a> <a href="2d.path.transformation.basic.html">2d.path.transformation.basic</a> <a href="2d.path.transformation.multiple.html">2d.path.transformation.multiple</a> <a href="2d.path.transformation.changing.html">2d.path.transformation.changing</a> </span>.</p>
  ...
  again has zero subpaths<span class="testrefs kw-must" id="testrefs.2d.path.beginPath"> <a href="#testrefs.2d.path.beginPath" title="2d.path.beginPath">#</a> <a href="2d.path.beginPath.html">2d.path.beginPath</a> </span>.</p>
  ...
  only) point<span class="testrefs kw-must" id="testrefs.2d.path.moveTo"> <a href="#testrefs.2d.path.moveTo" title="2d.path.moveTo">#</a> <a href="2d.path.moveTo.basic.html">2d.path.moveTo.basic</a> <a href="2d.path.moveTo.newsubpath.html">2d.path.moveTo.newsubpath</a> <a href="2d.path.moveTo.multiple.html">2d.path.moveTo.multiple</a> </span>.</p>
  ...
  called<span class="testrefs kw-must" id="testrefs.2d.path.ensure"> <a href="#testrefs.2d.path.ensure" title="2d.path.ensure">#</a> <a href="2d.path.lineTo.ensuresubpath.1.html">2d.path.lineTo.ensuresubpath.1</a> <a href="2d.path.lineTo.ensuresubpath.2.html">2d.path.lineTo.ensuresubpath.2</a> <a href="2d.path.quadraticCurveTo.ensuresubpath.1.html">2d.path.quadraticCurveTo.ensuresubpath.1</a> <a href="2d.path.quadraticCurveTo.ensuresubpath.2.html">2d.path.quadraticCurveTo.ensuresubpath.2</a> <a href="2d.path.bezierCurveTo.ensuresubpath.1.html">2d.path.bezierCurveTo.ensuresubpath.1</a> <a href="2d.path.bezierCurveTo.ensuresubpath.2.html">2d.path.bezierCurveTo.ensuresubpath.2</a> <a href="2d.path.arcTo.ensuresubpath.1.html">2d.path.arcTo.ensuresubpath.1</a> <a href="2d.path.arcTo.ensuresubpath.2.html">2d.path.arcTo.ensuresubpath.2</a> </span>.</p>


  <p>The <dfn id="dom-context-2d-closepath" title="dom-context-2d-closePath"><code>closePath()</code></dfn>
  method must do nothing if the context has no subpaths<span class="testrefs kw-must" id="testrefs.2d.path.closePath.empty"> <a href="#testrefs.2d.path.closePath.empty" title="2d.path.closePath.empty">#</a> <a href="2d.path.closePath.empty.html">2d.path.closePath.empty</a> </span>. Otherwise, it
  ...
  finally add this new subpath to the path<span class="testrefs kw-must" id="testrefs.2d.path.closePath.nonempty"> <a href="#testrefs.2d.path.closePath.nonempty" title="2d.path.closePath.nonempty">#</a> <a href="2d.path.closePath.newline.html">2d.path.closePath.newline</a> <a href="2d.path.closePath.nextpoint.html">2d.path.closePath.nextpoint</a> </span>.</p>
  ...
  no subpaths<span class="testrefs kw-must" id="testrefs.2d.path.lineTo.empty"> <a href="#testrefs.2d.path.lineTo.empty" title="2d.path.lineTo.empty">#</a> <a href="2d.path.lineTo.ensuresubpath.1.html">2d.path.lineTo.ensuresubpath.1</a> <a href="2d.path.lineTo.ensuresubpath.2.html">2d.path.lineTo.ensuresubpath.2</a> </span>. Otherwise, it must connect the last point in the
  ...
  subpath<span class="testrefs kw-must" id="testrefs.2d.path.lineTo.nonempty"> <a href="#testrefs.2d.path.lineTo.nonempty" title="2d.path.lineTo.nonempty">#</a> <a href="2d.path.lineTo.basic.html">2d.path.lineTo.basic</a> <a href="2d.path.lineTo.nextpoint.html">2d.path.lineTo.nextpoint</a> </span>.</p>
  ...
  <var title="">cpy</var>)</span><span class="testrefs kw-must" id="testrefs.2d.path.quadratic.empty"> <a href="#testrefs.2d.path.quadratic.empty" title="2d.path.quadratic.empty">#</a> <a href="2d.path.quadraticCurveTo.ensuresubpath.1.html">2d.path.quadraticCurveTo.ensuresubpath.1</a> <a href="2d.path.quadraticCurveTo.ensuresubpath.2.html">2d.path.quadraticCurveTo.ensuresubpath.2</a> </span>, and then must connect the last
  ...
  then add the given point (<var title="">x</var>, <var title="">y</var>) to the subpath<span class="testrefs kw-must" id="testrefs.2d.path.quadratic.nonempty"> <a href="#testrefs.2d.path.quadratic.nonempty" title="2d.path.quadratic.nonempty">#</a> <a href="2d.path.quadraticCurveTo.basic.html">2d.path.quadraticCurveTo.basic</a> <a href="2d.path.quadraticCurveTo.shape.html">2d.path.quadraticCurveTo.shape</a> <a href="2d.path.quadraticCurveTo.scaled.html">2d.path.quadraticCurveTo.scaled</a> </span>. <a href="#refsBEZIER">[BEZIER]</a></p>
  ...
  <a href="#ensure-there-is-a-subpath">ensure there is a subpath</a> for <span title="">(<var title="">cp1x</var>, <var title="">cp1y</var>)</span><span class="testrefs kw-must" id="testrefs.2d.path.bezier.empty"> <a href="#testrefs.2d.path.bezier.empty" title="2d.path.bezier.empty">#</a> <a href="2d.path.bezierCurveTo.ensuresubpath.1.html">2d.path.bezierCurveTo.ensuresubpath.1</a> <a href="2d.path.bezierCurveTo.ensuresubpath.2.html">2d.path.bezierCurveTo.ensuresubpath.2</a> </span>, and then must
  connect the last point in the subpath to the given point (<var title="">x</var>, <var title="">y</var>) using a cubic Bézier
  curve with control points (<var title="">cp1x</var>, <var title="">cp1y</var>) and (<var title="">cp2x</var>, <var title="">cp2y</var>). Then, it must add the point (<var title="">x</var>, <var title="">y</var>) to the subpath<span class="testrefs kw-must" id="testrefs.2d.path.bezier.nonempty"> <a href="#testrefs.2d.path.bezier.nonempty" title="2d.path.bezier.nonempty">#</a> <a href="2d.path.bezierCurveTo.basic.html">2d.path.bezierCurveTo.basic</a> <a href="2d.path.bezierCurveTo.shape.html">2d.path.bezierCurveTo.shape</a> <a href="2d.path.bezierCurveTo.scaled.html">2d.path.bezierCurveTo.scaled</a> </span>. <a href="#refsBEZIER">[BEZIER]</a></p>
  ...
  method must first <a href="#ensure-there-is-a-subpath">ensure there is a subpath</a> for <span title="">(<var title="">x1</var>, <var title="">y1</var>)</span><span class="testrefs kw-must" id="testrefs.2d.path.arcTo.empty"> <a href="#testrefs.2d.path.arcTo.empty" title="2d.path.arcTo.empty">#</a> <a href="2d.path.arcTo.ensuresubpath.1.html">2d.path.arcTo.ensuresubpath.1</a> <a href="2d.path.arcTo.ensuresubpath.2.html">2d.path.arcTo.ensuresubpath.2</a> </span>. Then, the behavior depends on the
  ...
  exception<span class="testrefs kw-must" id="testrefs.2d.path.arcTo.negative"> <a href="#testrefs.2d.path.arcTo.negative" title="2d.path.arcTo.negative">#</a> <a href="2d.path.arcTo.negative.html">2d.path.arcTo.negative</a> </span>.</p>
  ...
  equal to the point (<var title="">x1</var>, <var title="">y1</var>)<span class="testrefs kw-must" id="testrefs.2d.path.arcTo.coincide.01"> <a href="#testrefs.2d.path.arcTo.coincide.01" title="2d.path.arcTo.coincide.01">#</a> <a href="2d.path.arcTo.coincide.1.html">2d.path.arcTo.coincide.1</a> </span>,
  or if the point (<var title="">x1</var>, <var title="">y1</var>) is
  equal to the point (<var title="">x2</var>, <var title="">y2</var>)<span class="testrefs kw-must" id="testrefs.2d.path.arcTo.coincide.12"> <a href="#testrefs.2d.path.arcTo.coincide.12" title="2d.path.arcTo.coincide.12">#</a> <a href="2d.path.arcTo.coincide.2.html">2d.path.arcTo.coincide.2</a> </span>,
  or if the radius <var title="">radius</var> is zero<span class="testrefs kw-must" id="testrefs.2d.path.arcTo.zeroradius"> <a href="#testrefs.2d.path.arcTo.zeroradius" title="2d.path.arcTo.zeroradius">#</a> <a href="2d.path.arcTo.zero.1.html">2d.path.arcTo.zero.1</a> <a href="2d.path.arcTo.zero.2.html">2d.path.arcTo.zero.2</a> </span>, then the method
  ...
  straight line<span class="testrefs kw-must" id="testrefs.2d.path.arcTo.collinear"> <a href="#testrefs.2d.path.arcTo.collinear" title="2d.path.arcTo.collinear">#</a> <a href="2d.path.arcTo.collinear.1.html">2d.path.arcTo.collinear.1</a> <a href="2d.path.arcTo.collinear.2.html">2d.path.arcTo.collinear.2</a> <a href="2d.path.arcTo.collinear.3.html">2d.path.arcTo.collinear.3</a> </span>.</p>
  ...
  tangent point to the subpath<span class="testrefs kw-must" id="testrefs.2d.path.arcTo.shape"> <a href="#testrefs.2d.path.arcTo.shape" title="2d.path.arcTo.shape">#</a> <a href="2d.path.arcTo.shape.curve1.html">2d.path.arcTo.shape.curve1</a> <a href="2d.path.arcTo.shape.curve2.html">2d.path.arcTo.shape.curve2</a> <a href="2d.path.arcTo.shape.start.html">2d.path.arcTo.shape.start</a> <a href="2d.path.arcTo.shape.end.html">2d.path.arcTo.shape.end</a> </span>.</p>
  ...
  arc<span class="testrefs kw-must" id="testrefs.2d.path.arc.nonempty"> <a href="#testrefs.2d.path.arc.nonempty" title="2d.path.arc.nonempty">#</a> <a href="2d.path.arc.empty.html">2d.path.arc.empty</a> <a href="2d.path.arc.nonempty.html">2d.path.arc.nonempty</a> </span>. In any case, it must draw the arc between the start point of
  the arc and the end point of the arc, and add the start and end
  points of the arc to the subpath<span class="testrefs kw-must" id="testrefs.2d.path.arc.draw"> <a href="#testrefs.2d.path.arc.draw" title="2d.path.arc.draw">#</a> <a href="2d.path.arc.end.html">2d.path.arc.end</a> <a href="2d.path.arc.angle.1.html">2d.path.arc.angle.1</a> <a href="2d.path.arc.angle.2.html">2d.path.arc.angle.2</a> <a href="2d.path.arc.angle.3.html">2d.path.arc.angle.3</a> <a href="2d.path.arc.angle.4.html">2d.path.arc.angle.4</a> <a href="2d.path.arc.angle.5.html">2d.path.arc.angle.5</a> <a href="2d.path.arc.angle.6.html">2d.path.arc.angle.6</a> <a href="2d.path.arc.zero.1.html">2d.path.arc.zero.1</a> <a href="2d.path.arc.zero.2.html">2d.path.arc.zero.2</a> <a href="2d.path.arc.twopie.1.html">2d.path.arc.twopie.1</a> <a href="2d.path.arc.twopie.2.html">2d.path.arc.twopie.2</a> <a href="2d.path.arc.twopie.3.html">2d.path.arc.twopie.3</a> <a href="2d.path.arc.twopie.4.html">2d.path.arc.twopie.4</a> <a href="2d.path.arc.shape.1.html">2d.path.arc.shape.1</a> <a href="2d.path.arc.shape.2.html">2d.path.arc.shape.2</a> <a href="2d.path.arc.shape.3.html">2d.path.arc.shape.3</a> <a href="2d.path.arc.shape.4.html">2d.path.arc.shape.4</a> <a href="2d.path.arc.shape.5.html">2d.path.arc.shape.5</a> <a href="2d.path.arc.selfintersect.1.html">2d.path.arc.selfintersect.1</a> <a href="2d.path.arc.selfintersect.2.html">2d.path.arc.selfintersect.2</a> <a href="2d.path.arc.scale.2.html">2d.path.arc.scale.2</a> </span>. The arc and its start and end
  ...
  same, or if the radius is zero<span class="testrefs kw-none" id="testrefs.2d.path.arc.zero"> <a href="#testrefs.2d.path.arc.zero" title="2d.path.arc.zero">#</a> <a href="2d.path.arc.zeroradius.html">2d.path.arc.zeroradius</a> </span>, then the arc is defined as being of
  zero length in both directions.</p>

  <p>Negative values for <var title="">radius</var> must cause the
  implementation to raise an <code><a href="#index_size_err">INDEX_SIZE_ERR</a></code>
  exception<span class="testrefs kw-must" id="testrefs.2d.path.arc.negative"> <a href="#testrefs.2d.path.arc.negative" title="2d.path.arc.negative">#</a> <a href="2d.path.arc.negative.html">2d.path.arc.negative</a> </span>.</p>
  ...
  lines<span class="testrefs kw-must" id="testrefs.2d.path.rect.subpath"> <a href="#testrefs.2d.path.rect.subpath" title="2d.path.rect.subpath">#</a> <a href="2d.path.rect.basic.html">2d.path.rect.basic</a> <a href="2d.path.rect.newsubpath.html">2d.path.rect.newsubpath</a> <a href="2d.path.rect.zero.1.html">2d.path.rect.zero.1</a> <a href="2d.path.rect.zero.2.html">2d.path.rect.zero.2</a> <a href="2d.path.rect.zero.3.html">2d.path.rect.zero.3</a> <a href="2d.path.rect.zero.4.html">2d.path.rect.zero.4</a> <a href="2d.path.rect.zero.5.html">2d.path.rect.zero.5</a> <a href="2d.path.rect.zero.6.html">2d.path.rect.zero.6</a> <a href="2d.path.rect.negative.html">2d.path.rect.negative</a> <a href="2d.path.rect.winding.html">2d.path.rect.winding</a> </span>, and must then mark the subpath as closed<span class="testrefs kw-must" id="testrefs.2d.path.rect.closed"> <a href="#testrefs.2d.path.rect.closed" title="2d.path.rect.closed">#</a> <a href="2d.path.rect.closed.html">2d.path.rect.closed</a> </span>. It must then create
  a new subpath with the point (<var title="">x</var>, <var title="">y</var>) as the only point in the subpath<span class="testrefs kw-must" id="testrefs.2d.path.rect.newsubpath"> <a href="#testrefs.2d.path.rect.newsubpath" title="2d.path.rect.newsubpath">#</a> <a href="2d.path.rect.end.1.html">2d.path.rect.end.1</a> <a href="2d.path.rect.end.2.html">2d.path.rect.end.2</a> </span>.</p>
  ...
  the non-zero winding number rule<span class="testrefs kw-must" id="testrefs.2d.path.fill.basic"> <a href="#testrefs.2d.path.fill.basic" title="2d.path.fill.basic">#</a> <a href="2d.path.fill.overlap.html">2d.path.fill.overlap</a> <a href="2d.path.fill.winding.add.html">2d.path.fill.winding.add</a> <a href="2d.path.fill.winding.subtract.1.html">2d.path.fill.winding.subtract.1</a> <a href="2d.path.fill.winding.subtract.2.html">2d.path.fill.winding.subtract.2</a> <a href="2d.path.fill.winding.subtract.3.html">2d.path.fill.winding.subtract.3</a> </span>. Open subpaths must be implicitly
  closed when being filled (without affecting the actual
  subpaths)<span class="testrefs kw-must" id="testrefs.2d.path.fill.closed"> <a href="#testrefs.2d.path.fill.closed" title="2d.path.fill.closed">#</a> <a href="2d.path.fill.closed.basic.html">2d.path.fill.closed.basic</a> <a href="2d.path.fill.closed.unaffected.html">2d.path.fill.closed.unaffected</a> </span>.</p>
  ...
  attribute<span class="testrefs kw-must" id="testrefs.2d.path.stroke.basic"> <a href="#testrefs.2d.path.stroke.basic" title="2d.path.stroke.basic">#</a> <a href="2d.path.stroke.overlap.html">2d.path.stroke.overlap</a> <a href="2d.path.stroke.union.html">2d.path.stroke.union</a> <a href="2d.path.stroke.unaffected.html">2d.path.stroke.unaffected</a> </span>.</p>
  ...
  the current path<span class="testrefs kw-must" id="testrefs.2d.path.unaffected"> <a href="#testrefs.2d.path.unaffected" title="2d.path.unaffected">#</a> </span>, and must be subject to <a href="#shadows" title="shadows">shadow effects</a>, <a href="#dom-context-2d-globalalpha" title="dom-context-2d-globalAlpha">global alpha</a>, the <a href="#clipping-region" title="clipping region">clipping region</a>, and <a href="#dom-context-2d-globalcompositeoperation" title="dom-context-2d-globalCompositeOperation">global composition
  operators</a><span class="testrefs kw-must" id="testrefs.2d.path.subjected"> <a href="#testrefs.2d.path.subjected" title="2d.path.subjected">#</a> </span>. (Transformations affect the path when the path is
  ...
  path<span class="testrefs kw-must" id="testrefs.2d.path.stroke.prune"> <a href="#testrefs.2d.path.stroke.prune" title="2d.path.stroke.prune">#</a> <a href="2d.path.stroke.prune.line.html">2d.path.stroke.prune.line</a> <a href="2d.path.stroke.prune.closed.html">2d.path.stroke.prune.closed</a> <a href="2d.path.stroke.prune.curve.html">2d.path.stroke.prune.curve</a> <a href="2d.path.stroke.prune.arc.html">2d.path.stroke.prune.arc</a> <a href="2d.path.stroke.prune.rect.html">2d.path.stroke.prune.rect</a> <a href="2d.path.stroke.prune.corner.html">2d.path.stroke.prune.corner</a> </span>. Empty subpaths must be ignored<span class="testrefs kw-must" id="testrefs.2d.path.stroke.empty"> <a href="#testrefs.2d.path.stroke.empty" title="2d.path.stroke.empty">#</a> <a href="2d.path.stroke.empty.html">2d.path.stroke.empty</a> </span>.</p>
  ...
  rule<span class="testrefs kw-must" id="testrefs.2d.path.clip.basic"> <a href="#testrefs.2d.path.clip.basic" title="2d.path.clip.basic">#</a> <a href="2d.path.clip.empty.html">2d.path.clip.empty</a> <a href="2d.path.clip.basic.1.html">2d.path.clip.basic.1</a> <a href="2d.path.clip.basic.2.html">2d.path.clip.basic.2</a> <a href="2d.path.clip.intersect.html">2d.path.clip.intersect</a> <a href="2d.path.clip.winding.1.html">2d.path.clip.winding.1</a> <a href="2d.path.clip.winding.2.html">2d.path.clip.winding.2</a> </span>. Open subpaths must be implicitly closed when computing the
  clipping region, without affecting the actual subpaths<span class="testrefs kw-must" id="testrefs.2d.path.clip.closed"> <a href="#testrefs.2d.path.clip.closed" title="2d.path.clip.closed">#</a> <a href="2d.path.clip.unaffected.html">2d.path.clip.unaffected</a> </span>. The new
  ...
  height of the coordinate space<span class="testrefs kw-must" id="testrefs.2d.path.clip.initial"> <a href="#testrefs.2d.path.clip.initial" title="2d.path.clip.initial">#</a> </span>.</p>
...
<!-- http://software.hixie.ch/utilities/js/live-dom-viewer/saved/340 -->
  ...
  sheet syntax like 'inherit')<span class="testrefs kw-must" id="testrefs.2d.text.font.parse"> <a href="#testrefs.2d.text.font.parse" title="2d.text.font.parse">#</a> <a href="2d.text.font.parse.basic.html">2d.text.font.parse.basic</a> <a href="2d.text.font.parse.complex.html">2d.text.font.parse.complex</a> <a href="2d.text.font.parse.size.percentage.html">2d.text.font.parse.size.percentage</a> <a href="2d.text.font.parse.system.html">2d.text.font.parse.system</a> </span>, and the resulting font must be
  assigned to the context, with the 'line-height' component forced to
  'normal'<span class="testrefs kw-must" id="testrefs.2d.text.font.lineheight"> <a href="#testrefs.2d.text.font.lineheight" title="2d.text.font.lineheight">#</a> <a href="2d.text.font.parse.complex.html">2d.text.font.parse.complex</a> </span>, with the 'font-size' component converted to CSS pixels<span class="testrefs kw-must" id="testrefs.2d.text.font.fontsize"> <a href="#testrefs.2d.text.font.fontsize" title="2d.text.font.fontsize">#</a> <a href="2d.text.font.parse.size.percentage.html">2d.text.font.parse.size.percentage</a> </span>,
  and with system fonts being computed to explicit values<span class="testrefs kw-must" id="testrefs.2d.text.font.systemfonts"> <a href="#testrefs.2d.text.font.systemfonts" title="2d.text.font.systemfonts">#</a> <a href="2d.text.font.parse.system.html">2d.text.font.parse.system</a> </span>. If the new
  ...
  value<span class="testrefs kw-must" id="testrefs.2d.text.font.invalid"> <a href="#testrefs.2d.text.font.invalid" title="2d.text.font.invalid">#</a> <a href="2d.text.font.parse.invalid.html">2d.text.font.parse.invalid</a> </span>. <a href="#refsCSS">[CSS]</a></p>
  ...
  they are loaded<span class="testrefs kw-must" id="testrefs.2d.text.font.fontface"> <a href="#testrefs.2d.text.font.fontface" title="2d.text.font.fontface">#</a> <a href="2d.text.draw.fontface.html">2d.text.draw.fontface</a> <a href="2d.text.draw.fontface.repeat.html">2d.text.draw.fontface.repeat</a> <a href="2d.text.draw.fontface.notinpage.html">2d.text.draw.fontface.notinpage</a> </span>. (If a font is referenced before it is fully loaded,
  then it must be treated as if it was an unknown font, falling back
  to another as described by the relevant CSS specifications<span class="testrefs kw-must" id="testrefs.2d.text.font.notfullyloaded"> <a href="#testrefs.2d.text.font.notfullyloaded" title="2d.text.font.notfullyloaded">#</a> </span>.) <a href="#refsCSSFONTS">[CSSFONTS]</a></p>
  ...
  (with no 'line-height' component)<span class="testrefs kw-must" id="testrefs.2d.text.font.get"> <a href="#testrefs.2d.text.font.get" title="2d.text.font.get">#</a> <a href="2d.text.font.parse.basic.html">2d.text.font.parse.basic</a> <a href="2d.text.font.parse.complex.html">2d.text.font.parse.complex</a> <a href="2d.text.font.parse.size.percentage.html">2d.text.font.parse.size.percentage</a> <a href="2d.text.font.parse.system.html">2d.text.font.parse.system</a> </span>. <a href="#refsCSSOM">[CSSOM]</a></p>
  ...
  to 10px sans-serif<span class="testrefs kw-must" id="testrefs.2d.text.font.default"> <a href="#testrefs.2d.text.font.default" title="2d.text.font.default">#</a> <a href="2d.text.font.default.html">2d.text.font.default</a> </span>. When the 'font-size' component is set to lengths
  ...
  element at the time that the attribute is set<span class="testrefs kw-must" id="testrefs.2d.text.font.size"> <a href="#testrefs.2d.text.font.size" title="2d.text.font.size">#</a> <a href="2d.text.font.parse.size.percentage.html">2d.text.font.parse.size.percentage</a> </span>. When the
  ...
  set<span class="testrefs kw-must" id="testrefs.2d.text.font.weight"> <a href="#testrefs.2d.text.font.weight" title="2d.text.font.weight">#</a> </span>. If the computed values are undefined for a particular case
  ...
  default<span class="testrefs kw-must" id="testrefs.2d.text.font.undefined"> <a href="#testrefs.2d.text.font.undefined" title="2d.text.font.undefined">#</a> <a href="2d.text.font.parse.size.percentage.default.html">2d.text.font.parse.size.percentage.default</a> </span>.</p>

  <p>The <dfn id="dom-context-2d-textalign" title="dom-context-2d-textAlign"><code>textAlign</code></dfn> IDL
  attribute, on getting, must return the current value<span class="testrefs kw-must" id="testrefs.2d.text.align.get"> <a href="#testrefs.2d.text.align.get" title="2d.text.align.get">#</a> <a href="2d.text.align.valid.html">2d.text.align.valid</a> </span>. On setting, if
  ...
  value must be changed to the new value<span class="testrefs kw-must" id="testrefs.2d.text.align.set"> <a href="#testrefs.2d.text.align.set" title="2d.text.align.set">#</a> <a href="2d.text.align.valid.html">2d.text.align.valid</a> </span>. Otherwise, the new value
  must be ignored<span class="testrefs kw-must" id="testrefs.2d.text.align.invalid"> <a href="#testrefs.2d.text.align.invalid" title="2d.text.align.invalid">#</a> <a href="2d.text.align.invalid.html">2d.text.align.invalid</a> </span>. When the context is created, the <code title="dom-context-2d-textAlign"><a href="#dom-context-2d-textalign">textAlign</a></code> attribute must
  initially have the value <code title="">start</code><span class="testrefs kw-must" id="testrefs.2d.text.align.default"> <a href="#testrefs.2d.text.align.default" title="2d.text.align.default">#</a> <a href="2d.text.align.default.html">2d.text.align.default</a> </span>.</p>

  <p>The <dfn id="dom-context-2d-textbaseline" title="dom-context-2d-textBaseline"><code>textBaseline</code></dfn>
  IDL attribute, on getting, must return the current value<span class="testrefs kw-must" id="testrefs.2d.text.baseline.get"> <a href="#testrefs.2d.text.baseline.get" title="2d.text.baseline.get">#</a> <a href="2d.text.baseline.valid.html">2d.text.baseline.valid</a> </span>. On
  ...
  then the value must be changed to the new value<span class="testrefs kw-must" id="testrefs.2d.text.baseline.set"> <a href="#testrefs.2d.text.baseline.set" title="2d.text.baseline.set">#</a> <a href="2d.text.baseline.valid.html">2d.text.baseline.valid</a> </span>. Otherwise, the new
  value must be ignored<span class="testrefs kw-must" id="testrefs.2d.text.baseline.invalid"> <a href="#testrefs.2d.text.baseline.invalid" title="2d.text.baseline.invalid">#</a> <a href="2d.text.baseline.invalid.html">2d.text.baseline.invalid</a> </span>. When the context is created, the <code title="dom-context-2d-textBaseline"><a href="#dom-context-2d-textbaseline">textBaseline</a></code> attribute
  must initially have the value <code title="">alphabetic</code><span class="testrefs kw-must" id="testrefs.2d.text.baseline.default"> <a href="#testrefs.2d.text.baseline.default" title="2d.text.baseline.default">#</a> <a href="2d.text.baseline.default.html">2d.text.baseline.default</a> </span>.</p>
  ...
  must run the following steps<span class="testrefs kw-must" id="testrefs.2d.text.draw"> <a href="#testrefs.2d.text.draw" title="2d.text.draw">#</a> <a href="2d.text.draw.fill.basic.html">2d.text.draw.fill.basic</a> <a href="2d.text.draw.fill.rtl.html">2d.text.draw.fill.rtl</a> <a href="2d.text.draw.stroke.basic.html">2d.text.draw.stroke.basic</a> <a href="2d.text.draw.kern.consistent.html">2d.text.draw.kern.consistent</a> </span>:</p>
  ...
  <ol><li><p>Let <var title="">font</var> be the current font of the
   ...
   characters<span class="testrefs kw-none" id="testrefs.2d.text.draw.spaces"> <a href="#testrefs.2d.text.draw.spaces" title="2d.text.draw.spaces">#</a> <a href="2d.text.draw.space.basic.html">2d.text.draw.space.basic</a> <a href="2d.text.draw.space.collapse.space.html">2d.text.draw.space.collapse.space</a> <a href="2d.text.draw.space.collapse.other.html">2d.text.draw.space.collapse.other</a> <a href="2d.text.draw.space.collapse.nonspace.html">2d.text.draw.space.collapse.nonspace</a> <a href="2d.text.draw.space.collapse.start.html">2d.text.draw.space.collapse.start</a> <a href="2d.text.draw.space.collapse.end.html">2d.text.draw.space.collapse.end</a> </span>.</p></li>
   ...
   directionality</a> of the <code><a href="#the-canvas-element">canvas</a></code> element<span class="testrefs kw-none" id="testrefs.2d.text.draw.direction"> <a href="#testrefs.2d.text.draw.direction" title="2d.text.draw.direction">#</a> <a href="2d.text.draw.align.start.rtl.html">2d.text.draw.align.start.rtl</a> <a href="2d.text.draw.align.end.rtl.html">2d.text.draw.align.end.rtl</a> </span>. <a href="#refsCSS">[CSS]</a></p></li>
   ...
   smaller font, and return to the previous step<span class="testrefs kw-none" id="testrefs.2d.text.draw.maxwidth"> <a href="#testrefs.2d.text.draw.maxwidth" title="2d.text.draw.maxwidth">#</a> <a href="2d.text.draw.fill.maxWidth.large.html">2d.text.draw.fill.maxWidth.large</a> <a href="2d.text.draw.fill.maxWidth.small.html">2d.text.draw.fill.maxWidth.small</a> <a href="2d.text.draw.fill.maxWidth.zero.html">2d.text.draw.fill.maxWidth.zero</a> <a href="2d.text.draw.fill.maxWidth.fontface.html">2d.text.draw.fill.maxWidth.fontface</a> <a href="2d.text.draw.fill.maxWidth.bound.html">2d.text.draw.fill.maxWidth.bound</a> </span>.</p></li>
   ...
   <li>
    ...
    <dl><dt> If <code title="dom-context-2d-textAlign"><a href="#dom-context-2d-textalign">textAlign</a></code> is <code title="">left</code></dt>
     ...
     position be the left edge of the inline box<span class="testrefs kw-none" id="testrefs.2d.text.align.left"> <a href="#testrefs.2d.text.align.left" title="2d.text.align.left">#</a> <a href="2d.text.draw.align.left.html">2d.text.draw.align.left</a> <a href="2d.text.draw.align.start.ltr.html">2d.text.draw.align.start.ltr</a> <a href="2d.text.draw.align.end.rtl.html">2d.text.draw.align.end.rtl</a> </span>.</dd>
     ...
     <dd>Let the <var title="">anchor point</var>'s horizontal
     position be the right edge of the inline box<span class="testrefs kw-none" id="testrefs.2d.text.align.right"> <a href="#testrefs.2d.text.align.right" title="2d.text.align.right">#</a> <a href="2d.text.draw.align.right.html">2d.text.draw.align.right</a> <a href="2d.text.draw.align.start.rtl.html">2d.text.draw.align.start.rtl</a> <a href="2d.text.draw.align.end.ltr.html">2d.text.draw.align.end.ltr</a> </span>.</dd>
     ...
     inline box<span class="testrefs kw-none" id="testrefs.2d.text.align.center"> <a href="#testrefs.2d.text.align.center" title="2d.text.align.center">#</a> <a href="2d.text.draw.align.center.html">2d.text.draw.align.center</a> </span>.</dd>
    ...
    <dl><dt> If <code title="dom-context-2d-textBaseline"><a href="#dom-context-2d-textbaseline">textBaseline</a></code> is <code title="dom-context-2d-textBaseline-top"><a href="#dom-context-2d-textbaseline-top">top</a></code></dt>
     ...
     inline box<span class="testrefs kw-none" id="testrefs.2d.text.baseline.top"> <a href="#testrefs.2d.text.baseline.top" title="2d.text.baseline.top">#</a> <a href="2d.text.draw.baseline.top.html">2d.text.draw.baseline.top</a> </span>.</dd>
     ...
     box<span class="testrefs kw-none" id="testrefs.2d.text.baseline.hanging"> <a href="#testrefs.2d.text.baseline.hanging" title="2d.text.baseline.hanging">#</a> <a href="2d.text.draw.baseline.hanging.html">2d.text.draw.baseline.hanging</a> </span>.</dd>
     ...
     first available font of the inline box<span class="testrefs kw-none" id="testrefs.2d.text.baseline.middle"> <a href="#testrefs.2d.text.baseline.middle" title="2d.text.baseline.middle">#</a> <a href="2d.text.draw.baseline.middle.html">2d.text.draw.baseline.middle</a> </span>.</dd>
     ...
     box<span class="testrefs kw-none" id="testrefs.2d.text.baseline.alphabetic"> <a href="#testrefs.2d.text.baseline.alphabetic" title="2d.text.baseline.alphabetic">#</a> <a href="2d.text.draw.baseline.alphabetic.html">2d.text.draw.baseline.alphabetic</a> </span>.</dd>
     ...
     box<span class="testrefs kw-none" id="testrefs.2d.text.baseline.ideographic"> <a href="#testrefs.2d.text.baseline.ideographic" title="2d.text.baseline.ideographic">#</a> <a href="2d.text.draw.baseline.ideographic.html">2d.text.draw.baseline.ideographic</a> </span>.</dd>
     ...
     inline box<span class="testrefs kw-none" id="testrefs.2d.text.baseline.bottom"> <a href="#testrefs.2d.text.baseline.bottom" title="2d.text.baseline.bottom">#</a> <a href="2d.text.draw.baseline.bottom.html">2d.text.draw.baseline.bottom</a> </span>.</dd>
   ...
   <li>
    ...
    ignored<span class="testrefs kw-must" id="testrefs.2d.text.draw.fill"> <a href="#testrefs.2d.text.draw.fill" title="2d.text.draw.fill">#</a> <a href="2d.text.draw.fill.basic.html">2d.text.draw.fill.basic</a> <a href="2d.text.draw.fill.unaffected.html">2d.text.draw.fill.unaffected</a> </span>. For <code title="dom-context-2d-strokeText"><a href="#dom-context-2d-stroketext">strokeText()</a></code> the reverse
    ...
    ignored<span class="testrefs kw-must" id="testrefs.2d.text.draw.stroke"> <a href="#testrefs.2d.text.draw.stroke" title="2d.text.draw.stroke">#</a> <a href="2d.text.draw.stroke.basic.html">2d.text.draw.stroke.basic</a> <a href="2d.text.draw.stroke.unaffected.html">2d.text.draw.stroke.unaffected</a> </span>.</p>
...
v5DVT (also check for '- -' bits in the part above) --><p>The <dfn id="dom-context-2d-measuretext" title="dom-context-2d-measureText"><code>measureText()</code></dfn>
  ...
  is invoked, the user agent must replace all the <a href="#space-character" title="space   character">space characters</a> in <var title="">text</var> with
  U+0020 SPACE characters<span class="testrefs kw-must" id="testrefs.2d.text.measure.spaces"> <a href="#testrefs.2d.text.measure.spaces" title="2d.text.measure.spaces">#</a> <a href="2d.text.measure.width.space.html">2d.text.measure.width.space</a> </span>, and then must form a hypothetical
  ...
  the width of that inline box, in CSS pixels<span class="testrefs kw-must" id="testrefs.2d.text.measure"> <a href="#testrefs.2d.text.measure" title="2d.text.measure">#</a> <a href="2d.text.measure.width.basic.html">2d.text.measure.width.basic</a> <a href="2d.text.measure.width.empty.html">2d.text.measure.width.empty</a> </span>. <a href="#refsCSS">[CSS]</a></p>
  ...
  <dl class="domintro"><dt><var title="">context</var> . <code title="dom-context-2d-drawImage"><a href="#dom-context-2d-drawimage">drawImage</a></code>(<var title="">image</var>, <var title="">dx</var>, <var title="">dy</var>)</dt>
   ...
   <dd>
    ...
    <p><img src="http://www.whatwg.org/specs/web-apps/current-work/images/drawImage.png" alt="The sx and sy parameters give the x and y coordinates of the source rectangle; the sw and sh arguments give the width and height of the source rectangle; the dx and dy give the x and y coordinates of the destination rectangle; and the dw and dh arguments give the width and height of the destination rectangle."></p>
  ...
  coordinate space<span class="testrefs kw-must" id="testrefs.2d.drawImage.defaultdest"> <a href="#testrefs.2d.drawImage.defaultdest" title="2d.drawImage.defaultdest">#</a> <a href="2d.drawImage.3arg.html">2d.drawImage.3arg</a> </span>. If the <var title="">sx</var>, <var title="">sy</var>, <var title="">sw</var>, and <var title="">sh</var> arguments are omitted, they must default to 0, 0,
  the image's intrinsic width in image pixels, and the image's
  intrinsic height in image pixels, respectively<span class="testrefs kw-must" id="testrefs.2d.drawImage.defaultsource"> <a href="#testrefs.2d.drawImage.defaultsource" title="2d.drawImage.defaultsource">#</a> <a href="2d.drawImage.3arg.html">2d.drawImage.3arg</a> <a href="2d.drawImage.5arg.html">2d.drawImage.5arg</a> </span>.</p>

  <p>The <var title="">image</var> argument is an instance of either
  <code><a href="#htmlimageelement">HTMLImageElement</a></code>, <code><a href="#htmlcanvaselement">HTMLCanvasElement</a></code>, or
  <code><a href="#htmlvideoelement">HTMLVideoElement</a></code>. If the <var title="">image</var> is
  of the wrong type or null, the implementation must raise a
  <code><a href="#type_mismatch_err">TYPE_MISMATCH_ERR</a></code> exception<span class="testrefs kw-must" id="testrefs.2d.drawImage.type"> <a href="#testrefs.2d.drawImage.type" title="2d.drawImage.type">#</a> <a href="2d.drawImage.null.html">2d.drawImage.null</a> <a href="2d.drawImage.wrongtype.html">2d.drawImage.wrongtype</a> </span>.</p>
  <!-- createPattern() has an equivalent paragraph -->

  <p>If the <var title="">image</var> argument is an
  <code><a href="#htmlimageelement">HTMLImageElement</a></code> object whose <code title="dom-img-complete"><a href="#dom-img-complete">complete</a></code> attribute is false<span class="testrefs kw-must" id="testrefs.2d.drawImage.incomplete.image"> <a href="#testrefs.2d.drawImage.incomplete.image" title="2d.drawImage.incomplete.image">#</a> <a href="2d.drawImage.incomplete.html">2d.drawImage.incomplete</a> <a href="2d.drawImage.broken.html">2d.drawImage.broken</a> </span>, or
  if the <var title="">image</var> argument is an
  <code><a href="#htmlvideoelement">HTMLVideoElement</a></code> object whose <code title="dom-media-readyState"><a href="#dom-media-readystate">readyState</a></code> attribute is either
  <code title="dom-media-HAVE_NOTHING"><a href="#dom-media-have_nothing">HAVE_NOTHING</a></code> or <code title="dom-media-HAVE_METADATA"><a href="#dom-media-have_metadata">HAVE_METADATA</a></code><span class="testrefs kw-must" id="testrefs.2d.drawImage.incomplete.video"> <a href="#testrefs.2d.drawImage.incomplete.video" title="2d.drawImage.incomplete.video">#</a> </span>, then the
  ...
  dimension or a vertical dimension equal to zero, then the
  implementation must raise an <code><a href="#invalid_state_err">INVALID_STATE_ERR</a></code>
  exception<span class="testrefs kw-must" id="testrefs.2d.drawImage.zerocanvas"> <a href="#testrefs.2d.drawImage.zerocanvas" title="2d.drawImage.zerocanvas">#</a> <a href="2d.drawImage.zerocanvas.html">2d.drawImage.zerocanvas</a> </span>.</p>
  <!-- createPattern() has an equivalent paragraph -->
  ...
  <p>If the source rectangle is not entirely within the source image<span class="testrefs kw-must" id="testrefs.2d.drawImage.outsidesource"> <a href="#testrefs.2d.drawImage.outsidesource" title="2d.drawImage.outsidesource">#</a> <a href="2d.drawImage.outsidesource.html">2d.drawImage.outsidesource</a> </span>,
  or if one of the <var title="">sw</var> or <var title="">sh</var>
  arguments is zero<span class="testrefs kw-must" id="testrefs.2d.drawImage.zerosource"> <a href="#testrefs.2d.drawImage.zerosource" title="2d.drawImage.zerosource">#</a> <a href="2d.drawImage.zerosource.html">2d.drawImage.zerosource</a> </span>, the implementation must raise an
  ...
  destination rectangle<span class="testrefs kw-must" id="testrefs.2d.drawImage.paint"> <a href="#testrefs.2d.drawImage.paint" title="2d.drawImage.paint">#</a> <a href="2d.drawImage.9arg.basic.html">2d.drawImage.9arg.basic</a> <a href="2d.drawImage.9arg.sourcepos.html">2d.drawImage.9arg.sourcepos</a> <a href="2d.drawImage.9arg.sourcesize.html">2d.drawImage.9arg.sourcesize</a> <a href="2d.drawImage.9arg.destpos.html">2d.drawImage.9arg.destpos</a> <a href="2d.drawImage.9arg.destsize.html">2d.drawImage.9arg.destsize</a> <a href="2d.drawImage.canvas.html">2d.drawImage.canvas</a> <a href="2d.drawImage.floatsource.html">2d.drawImage.floatsource</a> </span>, after applying the <a href="#transformations" title="dom-context-2d-transformation">current transformation
  ...
  element have no effect)<span class="testrefs kw-must" id="testrefs.2d.drawImage.original"> <a href="#testrefs.2d.drawImage.original" title="2d.drawImage.original">#</a> </span>. The image data must be processed in the
  original direction, even if the dimensions given are negative<span class="testrefs kw-must" id="testrefs.2d.drawImage.direction"> <a href="#testrefs.2d.drawImage.direction" title="2d.drawImage.direction">#</a> <a href="2d.drawImage.negativesource.html">2d.drawImage.negativesource</a> <a href="2d.drawImage.negativedest.html">2d.drawImage.negativedest</a> <a href="2d.drawImage.negativedir.html">2d.drawImage.negativedir</a> </span>. <!--
  ...
  onto overlapping parts of itself<span class="testrefs kw-none" id="testrefs.2d.drawImage.self"> <a href="#testrefs.2d.drawImage.self" title="2d.drawImage.self">#</a> <a href="2d.drawImage.self.1.html">2d.drawImage.self.1</a> <a href="2d.drawImage.self.2.html">2d.drawImage.self.2</a> </span>.</p>

  <p>When the <code title="dom-context-2d-drawImage"><a href="#dom-context-2d-drawimage">drawImage()</a></code> method
  is passed an animated image as its <var title="">image</var>
  argument, the user agent must use the poster frame of the animation,
  or, if there is no poster frame, the first frame of the
  animation<span class="testrefs kw-must" id="testrefs.2d.drawImage.animated.image"> <a href="#testrefs.2d.drawImage.animated.image" title="2d.drawImage.animated.image">#</a> <a href="2d.drawImage.animated.gif.html">2d.drawImage.animated.gif</a> <a href="2d.drawImage.animated.apng.html">2d.drawImage.animated.apng</a> <a href="2d.drawImage.animated.poster.html">2d.drawImage.animated.poster</a> </span>.</p>
  <!-- createPattern() has an equivalent paragraph -->

  <p>When the <var title="">image</var> argument is an
  <code><a href="#htmlvideoelement">HTMLVideoElement</a></code>, then the frame at the <a href="#current-playback-position">current
  playback position</a> must be used as the source image<span class="testrefs kw-must" id="testrefs.2d.drawImage.animated.video"> <a href="#testrefs.2d.drawImage.animated.video" title="2d.drawImage.animated.video">#</a> </span>, and the
  source image's dimensions must be the <a href="#concept-video-intrinsic-width" title="concept-video-intrinsic-width">intrinsic width</a> and
  <a href="#concept-video-intrinsic-height" title="concept-video-intrinsic-height">intrinsic height</a>
  of the <a href="#media-resource">media resource</a> (i.e. after any aspect-ratio
  correction has been applied)<span class="testrefs kw-must" id="testrefs.2d.drawImage.video.size"> <a href="#testrefs.2d.drawImage.video.size" title="2d.drawImage.video.size">#</a> </span>.</p>
  <!-- createPattern() has an equivalent paragraph -->

  <p>Images are painted without affecting the current path<span class="testrefs kw-none" id="testrefs.2d.drawImage.unaffect"> <a href="#testrefs.2d.drawImage.unaffect" title="2d.drawImage.unaffect">#</a> <a href="2d.drawImage.path.html">2d.drawImage.path</a> </span>, and are
  subject to <a href="#shadows" title="shadows">shadow effects</a>, <a href="#dom-context-2d-globalalpha" title="dom-context-2d-globalAlpha">global alpha</a>, the <a href="#clipping-region" title="clipping region">clipping region</a>, and <a href="#dom-context-2d-globalcompositeoperation" title="dom-context-2d-globalCompositeOperation">global composition
  ...
  <code><a href="#imagedata">ImageData</a></code> object<span class="testrefs kw-must" id="testrefs.2d.imageData.create2.object"> <a href="#testrefs.2d.imageData.create2.object" title="2d.imageData.create2.object">#</a> <a href="2d.imageData.create2.basic.html">2d.imageData.create2.basic</a> <a href="2d.imageData.create2.type.html">2d.imageData.create2.type</a> </span> representing a rectangle with a width
  in CSS pixels equal to the absolute magnitude of <var title="">sw</var> and a height in CSS pixels equal to the absolute
  magnitude of <var title="">sh</var><span class="testrefs kw-must" id="testrefs.2d.imageData.create2.size"> <a href="#testrefs.2d.imageData.create2.size" title="2d.imageData.create2.size">#</a> <a href="2d.imageData.create2.initial.html">2d.imageData.create2.initial</a> <a href="2d.imageData.create2.large.html">2d.imageData.create2.large</a> <a href="2d.imageData.create2.tiny.html">2d.imageData.create2.tiny</a> <a href="2d.imageData.create2.negative.html">2d.imageData.create2.negative</a> </span>. When invoked with a single <var title="">imagedata</var> argument, it must return an
  <code><a href="#imagedata">ImageData</a></code> object<span class="testrefs kw-must" id="testrefs.2d.imageData.create1.object"> <a href="#testrefs.2d.imageData.create1.object" title="2d.imageData.create1.object">#</a> <a href="2d.imageData.create1.basic.html">2d.imageData.create1.basic</a> <a href="2d.imageData.create1.type.html">2d.imageData.create1.type</a> </span> representing a rectangle with the same
  dimensions as the <code><a href="#imagedata">ImageData</a></code> object passed as the
  argument<span class="testrefs kw-must" id="testrefs.2d.imageData.create1.size"> <a href="#testrefs.2d.imageData.create1.size" title="2d.imageData.create1.size">#</a> <a href="2d.imageData.create1.initial.html">2d.imageData.create1.initial</a> </span>. The <code><a href="#imagedata">ImageData</a></code> object return must be filled
  with transparent black<span class="testrefs kw-none" id="testrefs.2d.imageData.create.initial"> <a href="#testrefs.2d.imageData.create.initial" title="2d.imageData.create.initial">#</a> <a href="2d.imageData.create2.initial.html">2d.imageData.create2.initial</a> <a href="2d.imageData.create1.initial.html">2d.imageData.create1.initial</a> </span>.</p>
  ...
  <code><a href="#imagedata">ImageData</a></code> object<span class="testrefs kw-must" id="testrefs.2d.imageData.get.object"> <a href="#testrefs.2d.imageData.get.object" title="2d.imageData.get.object">#</a> <a href="2d.imageData.get.type.html">2d.imageData.get.type</a> </span> representing the underlying pixel data
  ...
  coordinate space units<span class="testrefs kw-must" id="testrefs.2d.imageData.get.basic"> <a href="#testrefs.2d.imageData.get.basic" title="2d.imageData.get.basic">#</a> <a href="2d.imageData.get.basic.html">2d.imageData.get.basic</a> <a href="2d.imageData.get.source.outside.html">2d.imageData.get.source.outside</a> <a href="2d.imageData.get.source.negative.html">2d.imageData.get.source.negative</a> <a href="2d.imageData.get.source.size.html">2d.imageData.get.source.size</a> </span>. Pixels outside the canvas must be returned
  as transparent black<span class="testrefs kw-must" id="testrefs.2d.imageData.get.outside"> <a href="#testrefs.2d.imageData.get.outside" title="2d.imageData.get.outside">#</a> <a href="2d.imageData.get.source.outside.html">2d.imageData.get.source.outside</a> </span>. Pixels must be returned as non-premultiplied
  alpha values<span class="testrefs kw-must" id="testrefs.2d.imageData.get.premul"> <a href="#testrefs.2d.imageData.get.premul" title="2d.imageData.get.premul">#</a> <a href="2d.imageData.get.nonpremul.html">2d.imageData.get.nonpremul</a> </span>.</p>
  ...
  infinite or NaN<span class="testrefs kw-must" id="testrefs.2d.imageData.getcreate.nonfinite"> <a href="#testrefs.2d.imageData.getcreate.nonfinite" title="2d.imageData.getcreate.nonfinite">#</a> <a href="2d.imageData.create2.nonfinite.html">2d.imageData.create2.nonfinite</a> <a href="2d.imageData.get.nonfinite.html">2d.imageData.get.nonfinite</a> </span>, or if the <code title="dom-context-2d-createImageData"><a href="#dom-context-2d-createimagedata">createImageData()</a></code>
  method is invoked with only one argument but that argument is null<span class="testrefs kw-must" id="testrefs.2d.imageData.create.null"> <a href="#testrefs.2d.imageData.create.null" title="2d.imageData.create.null">#</a> <a href="2d.imageData.create1.zero.html">2d.imageData.create1.zero</a> </span>,
  ...
  an <code><a href="#index_size_err">INDEX_SIZE_ERR</a></code> exception<span class="testrefs kw-must" id="testrefs.2d.imageData.getcreate.zero"> <a href="#testrefs.2d.imageData.getcreate.zero" title="2d.imageData.getcreate.zero">#</a> <a href="2d.imageData.create2.zero.html">2d.imageData.create2.zero</a> <a href="2d.imageData.get.zero.html">2d.imageData.get.zero</a> </span>.</p>
  ...
  holding the image data<span class="testrefs kw-must" id="testrefs.2d.imageData.initial"> <a href="#testrefs.2d.imageData.initial" title="2d.imageData.initial">#</a> <a href="2d.imageData.create2.initial.html">2d.imageData.create2.initial</a> <a href="2d.imageData.create1.initial.html">2d.imageData.create1.initial</a> </span>. At least one pixel's worth of image data
  must be returned<span class="testrefs kw-must" id="testrefs.2d.imageData.one"> <a href="#testrefs.2d.imageData.one" title="2d.imageData.one">#</a> <a href="2d.imageData.create2.tiny.html">2d.imageData.create2.tiny</a> <a href="2d.imageData.get.tiny.html">2d.imageData.get.tiny</a> </span>.</p>
  ...
  each pixel<span class="testrefs kw-must" id="testrefs.2d.pixelarray.order"> <a href="#testrefs.2d.pixelarray.order" title="2d.pixelarray.order">#</a> <a href="2d.imageData.get.source.negative.html">2d.imageData.get.source.negative</a> <a href="2d.imageData.get.order.cols.html">2d.imageData.get.order.cols</a> <a href="2d.imageData.get.order.rows.html">2d.imageData.get.order.rows</a> <a href="2d.imageData.get.order.rgb.html">2d.imageData.get.order.rgb</a> <a href="2d.imageData.get.order.alpha.html">2d.imageData.get.order.alpha</a> </span>. Each component of each device pixel represented in this
  array must be in the range 0..255, representing the 8 bit value for
  that component<span class="testrefs kw-must" id="testrefs.2d.pixelarray.range"> <a href="#testrefs.2d.pixelarray.range" title="2d.pixelarray.range">#</a> <a href="2d.imageData.get.range.html">2d.imageData.get.range</a> <a href="2d.imageData.get.clamp.html">2d.imageData.get.clamp</a> </span>. The components must be assigned consecutive indices
  starting with 0 for the top left pixel's red component<span class="testrefs kw-must" id="testrefs.2d.pixelarray.indexes"> <a href="#testrefs.2d.pixelarray.indexes" title="2d.pixelarray.indexes">#</a> <a href="2d.imageData.get.order.rgb.html">2d.imageData.get.order.rgb</a> </span>.</p>
  ...
  number<span class="testrefs kw-must" id="testrefs.2d.pixelarray.length"> <a href="#testrefs.2d.pixelarray.length" title="2d.pixelarray.length">#</a> <a href="2d.imageData.get.length.html">2d.imageData.get.length</a> </span>.</p>
  ...
  array<span class="testrefs kw-must" id="testrefs.2d.pixelarray.retrieve"> <a href="#testrefs.2d.pixelarray.retrieve" title="2d.pixelarray.retrieve">#</a> <a href="2d.imageData.get.range.html">2d.imageData.get.range</a> </span>.</p>
  ...
  component in the array must be set to <var title="">value</var><span class="testrefs kw-must" id="testrefs.2d.pixelarray.modify"> <a href="#testrefs.2d.pixelarray.modify" title="2d.pixelarray.modify">#</a> <a href="2d.imageData.object.set.html">2d.imageData.object.set</a> <a href="2d.imageData.object.undefined.html">2d.imageData.object.undefined</a> <a href="2d.imageData.object.nan.html">2d.imageData.object.nan</a> <a href="2d.imageData.object.string.html">2d.imageData.object.string</a> <a href="2d.imageData.object.wrap.html">2d.imageData.object.wrap</a> <a href="2d.imageData.object.round.html">2d.imageData.object.round</a> </span>.</p>
  ...
  method must raise a <code><a href="#not_supported_err">NOT_SUPPORTED_ERR</a></code> exception<span class="testrefs kw-must" id="testrefs.2d.imageData.put.nonfinite"> <a href="#testrefs.2d.imageData.put.nonfinite" title="2d.imageData.put.nonfinite">#</a> <a href="2d.imageData.put.nonfinite.html">2d.imageData.put.nonfinite</a> </span>.</p>

  <p>If the first argument to the method is null<span class="testrefs kw-must" id="testrefs.2d.imageData.put.null"> <a href="#testrefs.2d.imageData.put.null" title="2d.imageData.put.null">#</a> <a href="2d.imageData.put.null.html">2d.imageData.put.null</a> </span> or not an
  <code><a href="#imagedata">ImageData</a></code> object<span class="testrefs kw-must" id="testrefs.2d.imageData.put.wrongtype"> <a href="#testrefs.2d.imageData.put.wrongtype" title="2d.imageData.put.wrongtype">#</a> <a href="2d.imageData.put.wrongtype.html">2d.imageData.put.wrongtype</a> </span> then the <code title="dom-context-2d-putImageData"><a href="#dom-context-2d-putimagedata">putImageData()</a></code> method
  ...
  have the values 0, 0, the <code title="dom-imagedata-width"><a href="#dom-imagedata-width">width</a></code> member of the <var title="">imagedata</var> structure, and the <code title="dom-imagedata-height"><a href="#dom-imagedata-height">height</a></code> member of the <var title="">imagedata</var> structure, respectively<span class="testrefs kw-must" id="testrefs.2d.imageData.put.3arg"> <a href="#testrefs.2d.imageData.put.3arg" title="2d.imageData.put.3arg">#</a> <a href="2d.imageData.put.basic.html">2d.imageData.put.basic</a> </span>.</p>
  ...
  must act as follows<span class="testrefs kw-must" id="testrefs.2d.imageData.put.normal"> <a href="#testrefs.2d.imageData.put.normal" title="2d.imageData.put.normal">#</a> <a href="2d.imageData.put.basic.html">2d.imageData.put.basic</a> <a href="2d.imageData.put.created.html">2d.imageData.put.created</a> <a href="2d.imageData.put.cross.html">2d.imageData.put.cross</a> <a href="2d.imageData.put.alpha.html">2d.imageData.put.alpha</a> <a href="2d.imageData.put.modified.html">2d.imageData.put.modified</a> <a href="2d.imageData.put.dirty.zero.html">2d.imageData.put.dirty.zero</a> <a href="2d.imageData.put.dirty.rect1.html">2d.imageData.put.dirty.rect1</a> <a href="2d.imageData.put.dirty.rect2.html">2d.imageData.put.dirty.rect2</a> <a href="2d.imageData.put.dirty.negative.html">2d.imageData.put.dirty.negative</a> <a href="2d.imageData.put.dirty.outside.html">2d.imageData.put.dirty.outside</a> <a href="2d.imageData.put.path.html">2d.imageData.put.path</a> </span>:</p>
  ...
  visible changes to the rendering<span class="testrefs kw-must" id="testrefs.2d.imageData.unchanged"> <a href="#testrefs.2d.imageData.unchanged" title="2d.imageData.unchanged">#</a> <a href="2d.imageData.put.unchanged.html">2d.imageData.put.unchanged</a> </span>:</p>
...
context.getImageData(0, 0, w, h);</pre>
  ...
  dimensions, for any value of <var title="">w</var> and <var title="">h</var><span class="testrefs kw-must" id="testrefs.2d.imageData.createround"> <a href="#testrefs.2d.imageData.createround" title="2d.imageData.createround">#</a> <a href="2d.imageData.create2.round.html">2d.imageData.create2.round</a> </span>. In other words, while user agents may round the
  ...
  methods<span class="testrefs kw-must" id="testrefs.2d.imageData.unaffected"> <a href="#testrefs.2d.imageData.unaffected" title="2d.imageData.unaffected">#</a> <a href="2d.imageData.get.unaffected.html">2d.imageData.get.unaffected</a> <a href="2d.imageData.put.unaffected.html">2d.imageData.put.unaffected</a> <a href="2d.imageData.put.clip.html">2d.imageData.put.clip</a> </span>.</p>
...
&lt;/html&gt;</pre>
  ...
  steps, in the order given (or act as if they do)<span class="testrefs kw-must" id="testrefs.2d.drawingmodel"> <a href="#testrefs.2d.drawingmodel" title="2d.drawingmodel">#</a> </span>:</p>
...
&lt;/script&gt;</pre>
  ...
  method with an <code><a href="#htmlimageelement">HTMLImageElement</a></code> object)<span class="testrefs kw-must" id="testrefs.2d.colorspace.correction"> <a href="#testrefs.2d.colorspace.correction" title="2d.colorspace.correction">#</a> </span>, and when
  ...
  returned<span class="testrefs kw-must" id="testrefs.2d.colorspace.toDataURL.info"> <a href="#testrefs.2d.colorspace.toDataURL.info" title="2d.colorspace.toDataURL.info">#</a> </span>. Where the output format allows it, the color of pixels in
  ...
  method<span class="testrefs kw-must" id="testrefs.2d.colorspace.toDataURL.equal"> <a href="#testrefs.2d.colorspace.toDataURL.equal" title="2d.colorspace.toDataURL.equal">#</a> </span>.</p>
  ...
  processing any colors for that element in CSS<span class="testrefs kw-must" id="testrefs.2d.colorspace.match"> <a href="#testrefs.2d.colorspace.match" title="2d.colorspace.match">#</a> </span>.</p>
  ...
  rendered<span class="testrefs kw-must" id="testrefs.2d.colorspace.img.equal"> <a href="#testrefs.2d.colorspace.img.equal" title="2d.colorspace.img.equal">#</a> </span>. Furthermore, the rendering of images that have no color
  ...
  rendered with no color correction<span class="testrefs kw-must" id="testrefs.2d.colorspace.img.noinfo"> <a href="#testrefs.2d.colorspace.img.noinfo" title="2d.colorspace.img.noinfo">#</a> </span>.</p>
  ...
  <i>origin-clean</i> set to true<span class="testrefs kw-must" id="testrefs.security.start"> <a href="#testrefs.security.start" title="security.start">#</a> <a href="security.pattern.create.html">security.pattern.create</a> <a href="security.pattern.cross.html">security.pattern.cross</a> <a href="security.pattern.canvas.timing.html">security.pattern.canvas.timing</a> </span>. The flag must be set to false if
  ...
  <ul><li><p>The element's 2D context's <code title="dom-context-2d-drawImage"><a href="#dom-context-2d-drawimage">drawImage()</a></code> method is
   ...
   element<span class="testrefs kw-must" id="testrefs.security.drawImage.image"> <a href="#testrefs.security.drawImage.image" title="security.drawImage.image">#</a> <a href="security.drawImage.image.html">security.drawImage.image</a> </span>.</p></li>
   ...
   <i>origin-clean</i> flag is false<span class="testrefs kw-must" id="testrefs.security.drawImage.canvas"> <a href="#testrefs.security.drawImage.canvas" title="security.drawImage.canvas">#</a> <a href="security.drawImage.canvas.html">security.drawImage.canvas</a> </span>.</p></li>
   ...
   <code><a href="#htmlimageelement">HTMLImageElement</a></code><span class="testrefs kw-must" id="testrefs.security.fillStyle.image"> <a href="#testrefs.security.fillStyle.image" title="security.fillStyle.image">#</a> <a href="security.pattern.image.fillStyle.html">security.pattern.image.fillStyle</a> </span> or an <code><a href="#htmlvideoelement">HTMLVideoElement</a></code><span class="testrefs kw-must" id="testrefs.security.fillStyle.video"> <a href="#testrefs.security.fillStyle.video" title="security.fillStyle.video">#</a> </span>
   whose <a href="#origin">origin</a> was not the <a href="#same-origin" title="same    origin">same</a> as that of the <code><a href="#document">Document</a></code> object
   ...
   false when the pattern was created<span class="testrefs kw-must" id="testrefs.security.fillStyle.canvas"> <a href="#testrefs.security.fillStyle.canvas" title="security.fillStyle.canvas">#</a> <a href="security.pattern.canvas.timing.html">security.pattern.canvas.timing</a> <a href="security.pattern.canvas.fillStyle.html">security.pattern.canvas.fillStyle</a> </span>.</p></li>
   ...
   <code><a href="#htmlimageelement">HTMLImageElement</a></code><span class="testrefs kw-must" id="testrefs.security.strokeStyle.image"> <a href="#testrefs.security.strokeStyle.image" title="security.strokeStyle.image">#</a> <a href="security.pattern.image.strokeStyle.html">security.pattern.image.strokeStyle</a> </span> or an <code><a href="#htmlvideoelement">HTMLVideoElement</a></code><span class="testrefs kw-must" id="testrefs.security.strokeStyle.video"> <a href="#testrefs.security.strokeStyle.video" title="security.strokeStyle.video">#</a> </span>
   whose <a href="#origin">origin</a> was not the <a href="#same-origin" title="same    origin">same</a> as that of the <code><a href="#document">Document</a></code> object
   that owns the <code><a href="#the-canvas-element">canvas</a></code> element when the pattern was
   created.</p></li>
   ...
   set to a <code><a href="#canvaspattern">CanvasPattern</a></code> object that was created from an
   <code><a href="#htmlcanvaselement">HTMLCanvasElement</a></code> whose <i>origin-clean</i> flag was
   false when the pattern was created<span class="testrefs kw-must" id="testrefs.security.strokeStyle.canvas"> <a href="#testrefs.security.strokeStyle.canvas" title="security.strokeStyle.canvas">#</a> <a href="security.pattern.canvas.strokeStyle.html">security.pattern.canvas.strokeStyle</a> </span>.</p></li>
  ...
  exception<span class="testrefs kw-must" id="testrefs.security.toDataURL"> <a href="#testrefs.security.toDataURL" title="security.toDataURL">#</a> <a href="security.drawImage.image.html">security.drawImage.image</a> </span>.</p>
  ...
  exception<span class="testrefs kw-must" id="testrefs.security.getImageData"> <a href="#testrefs.security.getImageData" title="security.getImageData">#</a> <a href="security.drawImage.image.html">security.drawImage.image</a> </span>.</p>
